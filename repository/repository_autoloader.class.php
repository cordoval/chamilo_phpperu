...
class RepositoryAutoloader
{
	...
	static function check_for_general_files($classname)
	{
		$list = array('abstract_content_object', 'accessible_content_object', 'catalog', 'complex_content_object_item_form', 'complex_content_object_item',
					  ...
					  'content_object', 'difference_engine', 'external_export_fedora', 'external_export', 'quota_manager', 'repository_block',
	...
	{
		$list = array('external_export_browser_form', 'external_export_export_form', 'metadata_lom_edit_form', 'metadata_lom_export_form',
