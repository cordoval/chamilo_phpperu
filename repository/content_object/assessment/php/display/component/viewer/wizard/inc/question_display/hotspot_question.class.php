...
class HotspotQuestionDisplay extends QuestionDisplay
{
    ...
    function add_question_form()
    {
        ...
        $formvalidator->addElement('html', ResourceManager :: get_instance()->get_resource_html(Path :: get(WEB_PATH) . 'repository/content_object/hotspot_question/resources/javascript/hotspot_question_display.js'));
