...
class AssessmentMatchingQuestionDisplay extends QuestionDisplay
{
    private $matches;
    private $answers;
    ...
    function add_answers()
    {
        ...
        $table_header[] = '<tr>';
        $table_header[] = '<th class="list"></th>';
        $table_header[] = '<th colspan="3">' . Translation :: get('MatchOptionAnswer') . '</th>';
        //		$table_header[] = '<th></th>';
        ...
        foreach ($answers as $answer_id => $answer)
        {
            ...
            $hint_name = 'hint_' . $question_id . '_' . $answer_id;
