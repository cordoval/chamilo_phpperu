 ...
 */
require_once dirname(__FILE__) . '/slideshare.class.php';
...
class SlideshareForm extends ContentObjectForm
{
    ...
    protected function build_creation_form()
    {
        ...
        $external_repositories = ExternalRepositoryLauncher :: get_links(Utilities :: get_classname_from_namespace(ExternalRepositoryManager :: CLASS_NAME, true), Slideshare :: get_type_name(), true);
