...
class MatchQuestionForm extends ContentObjectForm
{
    ...
    protected function build_creation_form()
    {
        ...
        $this->add_html_editor(MatchQuestion :: PROPERTY_HINT, Translation :: get('Hint', array(), Utilities :: get_namespace_from_object($this)), false, $html_editor_options);
        $renderer->setElementTemplate('{element}<div class="clear"></div>', MatchQuestion :: PROPERTY_HINT);
        $this->addElement('category');
    }
    ...
    function setDefaults($defaults = array ())
    {
        if (! $this->isSubmitted())
        {
            ...
            $defaults[MatchQuestion :: PROPERTY_HINT] = $object->get_hint();
    ...
    function create_content_object()
    {
        ...
        $object->set_hint($this->exportValue(MatchQuestion :: PROPERTY_HINT));
    ...
    {
        $this->get_content_object()->set_hint($this->exportValue(MatchQuestion :: PROPERTY_HINT));
        $this->add_options_to_object();
