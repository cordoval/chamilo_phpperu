...
class ObjectBrowserTableCellRenderer extends DefaultContentObjectTableCellRenderer
{
    ...
    private function get_modification_links($content_object)
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('SelectQuestion'), Theme :: get_common_image_path() . 'action_right.png', $this->browser->get_question_selector_url($content_object->get_id()), ToolbarItem :: DISPLAY_ICON));
