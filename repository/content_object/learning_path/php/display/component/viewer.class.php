...
//    private $complex_content_object_item;
    ...
    function run()
    {
        ...
        $learning_path_item_attempt_data = $this->get_parent()->retrieve_tracker_items($this->learning_path_trackers[self :: TRACKER_LEARNING_PATH]);
        ...
        if ($show_progress)
        {
            ...
            if ($complex_content_object_item_id)
            {
                $trail->add(new Breadcrumb(
                    $this->get_parent()->get_learning_path_content_object_item_details_url($complex_content_object_item_id),
                    Translation :: get('ItemDetails')
                    ));
            }
            ...
            {
                $trail->add(new Breadcrumb(
                    $this->get_parent()->get_learning_path_content_object_assessment_result_url($complex_content_object_item_id, $details),
                    Translation :: get('AssessmentResult')
                    ));
//
