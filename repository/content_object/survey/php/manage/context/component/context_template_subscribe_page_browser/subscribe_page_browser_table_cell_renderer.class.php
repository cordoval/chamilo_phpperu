...
class SurveyContextTemplateSubscribePageBrowserTableCellRenderer extends DefaultSurveyPageTableCellRenderer
{
    ...
    private function get_modification_links($page)
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('Subscribe'), Theme :: get_common_image_path() . 'action_subscribe.png', $this->browser->get_template_suscribe_page_url($template->get_id(), $page->get_id()), ToolbarItem :: DISPLAY_ICON));
