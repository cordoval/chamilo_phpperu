...
class SurveyContextManagerContextTemplateViewerComponent extends SurveyContextManager
{
    ...
    function get_action_bar()
    {
        ...
        $action_bar->add_tool_action(new ToolbarItem(Translation :: get('Import', null, Utilities::COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_import.png', $this->get_template_import_url($this->context_template), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
