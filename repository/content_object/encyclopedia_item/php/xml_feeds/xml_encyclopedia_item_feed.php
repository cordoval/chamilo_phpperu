<?php
namespace repositoty\content_object\encyclopedia_item;
...
if (Authentication :: is_valid())
{
    ...
    $objects = $dm->retrieve_type_content_objects(EncyclopediaItem :: get_type_name(), $condition, array(new ObjectTableOrder(ContentObject :: PROPERTY_TITLE)), array(SORT_ASC));
