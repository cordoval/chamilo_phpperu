    ...
    function get_content_object_type_creation_url($type)
    {
        if ($type == Handbook :: get_type_name())
        {
            return $this->get_url(array(
                    ...
                    ComplexBuilder :: PARAM_COMPLEX_CONTENT_OBJECT_ITEM_ID => ($this->get_complex_content_object_item() ? $this->get_complex_content_object_item()->get_id() : null)));
        }
        else
        {
            return $this->get_url(array(
                    ComplexBuilder :: PARAM_BUILDER_ACTION => HandbookBuilder :: ACTION_CREATE_HANDBOOK_ITEM,
                    ComplexBuilder :: PARAM_TYPE => $type,
