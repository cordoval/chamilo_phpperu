...
use application\peer_assessment\PeerAssessmentPublication;
...
class CompetencesPeerAssessmentViewerWizardPage extends PeerAssessmentViewerWizardPage
{
    ...
    function submit()
    {
        ...
        $button[] = $this->createElement('style_submit_button', $this->getButtonName('submit'), Translation :: get('Submit, null, Utilities::COMMON_LIBRARIES'), array(
                'class' => 'positive'))->toHtml();
        $button[] = '</div>';
