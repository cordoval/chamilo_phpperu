...
class CompetenceBuilderCreatorComponent extends CompetenceBuilder implements RepoViewerInterface
{
    ...
    function run()
    {
        ...
        $trail->add(new Breadcrumb($this->get_url(array('builder_action' => 'create_complex_content_object_item', 'type' => Request :: get('type', null, Utilities::COMMON_LIBRARIES))), Translation :: get('Create', null, Utilities::COMMON_LIBRARIES) . ' ' . Translation :: get(Utilities :: underscores_to_camelcase(Request :: get('type', null, Utilities::COMMON_LIBRARIES)))));
