...
class Autoloader
{
    ...
    static function check_for_general_files()
    {
        $list = array(
            ...
            'user_view', 'content_object_renderer', 'content_object_share', 'content_object_user_share', 'content_object_group_share', 'content_object_type_selector', 'content_object_type_selector_support');
