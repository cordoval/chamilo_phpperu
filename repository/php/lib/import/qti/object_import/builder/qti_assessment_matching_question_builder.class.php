 ...
 *
 */
class QtiAssessmentMatchingQuestionBuilder extends QtiQuestionBuilder {

    static function factory($item, $settings) {
        if (!class_exists('repository\content_object\assessment_matching_question\AssessmentMatchingQuestion') ||
