...
//require_once Path::get_repository_content_object_path() . '/survey_multiple_choice_question/php/survey_multiple_choice_question.class.php';
...
class QtiSurveyMultipleChoiceQuestionBuilder extends QtiQuestionBuilder {
    ...
    static function factory($item, $settings) {
        if (!class_exists('repository\content_object\survey_multiple_choice_question\SurveyMultipleChoiceQuestion') ||
