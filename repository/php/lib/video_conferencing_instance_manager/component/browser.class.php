...
class ExternalInstanceInstanceManagerBrowserComponent extends ExternalInstanceInstanceManager
{
    ...
    function get_condition()
    {
        ...
        {
            $conditions = array();
            $conditions[] = new PatternMatchCondition(ExternalInstance :: PROPERTY_TITLE, '*' . $query . '*');
            $conditions[] = new PatternMatchCondition(ExternalInstance :: PROPERTY_DESCRIPTION, '*' . $query . '*');
