...
/**
 * $Id: video_conferencing_repository_browser.class.php 204 2009-11-13 12:51:30Z kariboe $
 * @package repository.lib.repository_manager.component
 */

class RepositoryManagerVideoConferencingBrowserComponent extends RepositoryManagerVideoConferencingComponent
{
    ...
    function run()
    {
         ...
         * Header links
         */
        $trail->add(new Breadcrumb(null, Translation :: get('VideoConferencingList')));
        $this->display_header($trail, false, true);

        /*
         * Page content
         */
        $form = new VideoConferencingBrowserForm($content_object, '', $this->get_catalogs());
        $form->display();
