...
class RepositoryManagerVideoConferencingMetadataReviewerComponent extends VideoConferencingMetadataComponent
{
        ...
        if ($this->check_content_object_from_params())
        {
            ...
            switch ($metadata_type)
            {
                case self :: METADATA_FORMAT_LOM :
                    ...
                    $form = new MetadataLomEditForm($content_object->get_id(), $mapper, $this->get_url(array(RepositoryManager :: PARAM_CONTENT_OBJECT_ID => $content_object->get_id(), RepositoryManager :: PARAM_VIDEO_CONFERENCING_ID => Request :: get(RepositoryManager :: PARAM_VIDEO_CONFERENCING_ID))), $this->get_catalogs());
                    break;
                ...
                if ($form->must_save())
                {
                    if (isset($mapper))
                    {
                        ...
                        else
                        {
                             ...
                             */
                            Redirect :: url(array(Application :: PARAM_APPLICATION => RepositoryManager :: APPLICATION_NAME, Application :: PARAM_ACTION => RepositoryManager :: ACTION_VIDEO_CONFERENCING_EXPORT, RepositoryManager :: PARAM_VIDEO_CONFERENCING_ID => Request :: get(RepositoryManager :: PARAM_VIDEO_CONFERENCING_ID), RepositoryManager :: PARAM_CONTENT_OBJECT_ID => $content_object->get_id(), RepositoryManagerVideoConferencingExportComponent :: PARAM_FORCE_EXPORT => 1));
    ...
    {
        $missing_infos = Session :: retrieve(BaseVideoConferencingConnector :: SESSION_MISSING_FIELDS);
	     ...
	     */
        Session :: unregister(BaseVideoConferencingConnector :: SESSION_MISSING_FIELDS);
