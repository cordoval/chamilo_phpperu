...
class LinkBrowserTableDataProvider extends ObjectTableDataProvider
{
    ...
    function get_objects($offset, $count, $order_property = null)
    {
        ...
        if ($this->type == LinkBrowserTable :: TYPE_PARENTS)
        {
            ...
            {
                $subselect_condition = new EqualityCondition('reference_id', $this->get_browser()->get_object()->get_id());
                $conditions[] = new SubselectCondition(ComplexContentObjectItem :: PROPERTY_REF, ContentObject :: PROPERTY_ID, $helper_type, $subselect_condition);
            }
    ...
    function get_object_count()
    {
        ...
        if ($this->type == LinkBrowserTable :: TYPE_PARENTS)
        {
            ...
            $conditions[] = new SubselectCondition(ComplexContentObjectItem :: PROPERTY_REF, PortfolioItem :: PROPERTY_ID, 'portfolio_item', $subselect_condition);

            $subselect_condition = new EqualityCondition(LearningPathItem :: PROPERTY_REFERENCE, $this->get_browser()->get_object()->get_id());
            $conditions[] = new SubselectCondition(ComplexContentObjectItem :: PROPERTY_REF, LearningPathItem :: PROPERTY_ID, 'learning_path_item', $subselect_condition);
