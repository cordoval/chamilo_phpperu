 ...
 * @author jevdheyd
 */
class VideoConferencingUserQuotum extends DataClass {
    ...
    {
        return parent :: get_default_property_names(array(self :: PROPERTY_VIDEO_CONFERENCING_ID, self :: PROPERTY_USER_ID, self :: PROPERTY_QUOTUM));
    }
    ...
    function set_external_repository_id($video_conferencing_id)
    {
