...
class CpStreamingExport extends CpObjectExport
{
    ...
    public static function accept($object)
    {
        ...
        return ($object instanceof Youtube || $object->get_type() == Youtube :: get_type_name()) || ($object instanceof Dailymotion || $object->get_type() == Dailymotion :: get_type_name()) || ($object instanceof Vimeo || $object->get_type() == Vimeo :: get_type_name());
    }
