 ...
 *
 */
class QtiAssessmentMatrixQuestionSerializer extends QtiQuestionSerializer
{
    ...
    protected function add_interaction(ImsQtiWriter $body, AssessmentMatrixQuestion $question)
    {
        ...
        $match_max = $question->get_matrix_type() == AssessmentMatrixQuestion :: MATRIX_TYPE_RADIO ? 1 : 0;
