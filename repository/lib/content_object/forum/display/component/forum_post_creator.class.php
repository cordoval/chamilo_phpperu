...
class ForumDisplayForumPostCreatorComponent extends ForumDisplay
{
    ...
    function run()
    {
        ...
        $repo_viewer = new RepoViewer($this, ForumPost :: get_type_name(), RepoViewer :: SELECT_MULTIPLE, array(), false);
