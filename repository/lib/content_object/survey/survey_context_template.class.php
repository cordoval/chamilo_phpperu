...
class SurveyContextTemplate extends NestedTreeNode
{
    ...
    {
        return parent :: get_default_property_names(array(self :: PROPERTY_ID,self :: PROPERTY_NAME,self :: PROPERTY_DESCRIPTION, self :: PROPERTY_CONTEXT_TYPE, self :: PROPERTY_CONTEXT_TYPE_NAME, self :: PROPERTY_KEY_TYPE));
    }
    ...
    {
        return $this->get_default_property(self :: PROPERTY_KEY_TYPE);
    }
    ...
    {
        $this->set_default_property(self :: PROPERTY_KEY_TYPE, $key_type);
    }
