...
class HandbookBuilderUpdaterComponent extends HandbookBuilder
{
    ...
    function run()
    {
        ...
        $parameters = array(HandbookBuilder :: PARAM_COMPLEX_CONTENT_OBJECT_ITEM_ID => $parent_complex_content_object_item, HandbookBuilder :: PARAM_SELECTED_COMPLEX_CONTENT_OBJECT_ITEM_ID => $complex_content_object_item_id);
