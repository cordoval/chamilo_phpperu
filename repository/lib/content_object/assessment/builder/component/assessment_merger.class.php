...
class AssessmentBuilderAssessmentMergerComponent extends AssessmentBuilder implements RepoViewerInterface
{
    ...
    function get_question_selector_url($question_id, $assessment_id)
    {
        return $this->get_url(array(
                AssessmentBuilder :: PARAM_BUILDER_ACTION => AssessmentBuilder :: ACTION_SELECT_QUESTIONS, AssessmentBuilder :: PARAM_QUESTION_ID => $question_id, AssessmentBuilder :: PARAM_ASSESSMENT_ID => $assessment_id,
