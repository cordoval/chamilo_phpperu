    ...
    function run()
    {
        ...
        switch ($action)
        {
            ...
            case self :: ACTION_PAGE_STATISTICS :
                $component = $this->create_component(null, 'ReportingTemplateViewer');
