...
class WikiDisplayWikiHistoryComponent extends WikiDisplay
{
    ...
    function get_content_object_deletion_url($content_object, $type = null)
    {
        ...
        return $this->get_url(array(ComplexDisplay :: PARAM_DISPLAY_ACTION => WikiDisplay :: ACTION_VERSION_DELETE, RepositoryManager :: PARAM_CONTENT_OBJECT_ID => $content_object->get_id()));
    }
    ...
    function get_content_object_revert_url($content_object)
    {
        ...
        return $this->get_url(array(ComplexDisplay :: PARAM_DISPLAY_ACTION => WikiDisplay :: ACTION_VERSION_REVERT, RepositoryManager :: PARAM_CONTENT_OBJECT_ID => $content_object->get_id()));
    }
}
?>