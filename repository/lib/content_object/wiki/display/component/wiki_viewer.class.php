    ...
    function run()
    {
        ...
        if ($this->get_root_content_object() != null)
        {
            ...
            if (!is_null($complex_wiki_homepage))
            {
                ...
                $toolbar->add_item(new ToolbarItem(Translation :: get('Statistics'), Theme :: get_common_image_path() . 'action_statistics.png', $this->get_url(array(
                ...
                $html[] = '<div class="wiki-menu-section">';
                $toolbar = new Toolbar(Toolbar :: TYPE_VERTICAL);
                $toolbar->add_item(new ToolbarItem(Translation :: get('CreateWikiPage'), Theme :: get_common_image_path() . 'action_create.png', $this->get_url(array(
                ...
                $read_url = $this->get_url(array(ComplexDisplay :: PARAM_DISPLAY_ACTION => WikiDisplay :: ACTION_VIEW_WIKI_PAGE, ComplexDisplay :: PARAM_SELECTED_COMPLEX_CONTENT_OBJECT_ITEM_ID => $complex_wiki_homepage->get_id()));
                ...
                $html[] = '<li><a class="current" href="' . $read_url . '">Article</a></li>';
                ...
                $html[] = '<li><a class="current" href="' . $read_url . '">Read</a></li>';
