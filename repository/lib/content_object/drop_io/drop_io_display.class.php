...
class DropIoDisplay extends ContentObjectDisplay
{

    function get_video_element($width = 620, $height = 596)
    {     
    	return '<iframe src="' . $this->get_content_object()->get_video_url() . '" style="border:0px #FFFFFF none;" name="drop.io" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" width="'. $width . '" height="'. $height .'"></iframe>';
    }
