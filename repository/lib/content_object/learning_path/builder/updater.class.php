...
class LearningPathBuilderUpdaterComponent extends LearningPathBuilderComponent
{
    ...
    function run()
    {
        ...
        $complex_content_object_item_id = Request :: get(LearningPathBuilder :: PARAM_SELECTED_CLOI_ID);
        $parent_complex_content_object_item = Request :: get(LearningPathBuilder :: PARAM_CLOI_ID);
        
        $parameters = array(LearningPathBuilder :: PARAM_ROOT_CONTENT_OBJECT => $root_content_object, LearningPathBuilder :: PARAM_CLOI_ID => $parent_cloi, LearningPathBuilder :: PARAM_SELECTED_CLOI_ID => $cloi_id, 'publish' => Request :: get('publish'));
