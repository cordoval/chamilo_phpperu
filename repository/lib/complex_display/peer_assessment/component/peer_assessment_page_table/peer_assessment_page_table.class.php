<?php
require_once dirname(__FILE__) . '/peer_assessment_page_table_data_provider.class.php';
require_once dirname(__FILE__) . '/peer_assessment_page_table_column_model.class.php';
require_once dirname(__FILE__) . '/peer_assessment_page_table_cell_renderer.class.php';
/**
 ...
 */
class PeerAssessmentPageTable extends ObjectTable
{
     ...
     */
    function PeerAssessmentPageTable($parent, $owner)
    {
        
        $model = new PeerAssessmentPageTableColumnModel();
        $renderer = new PeerAssessmentPageTableCellRenderer($parent);
        $data_provider = new PeerAssessmentPageTableDataProvider($parent, $owner);
        parent :: __construct($data_provider, PeerAssessmentPageTable :: DEFAULT_NAME, $model, $renderer);
        
        $actions = array();
        
        $actions[] = new ObjectTableFormAction(PeerAssessmentDisplay :: ACTION_DELETE, Translation :: get('RestoreSelected'));
