	...
	function buildForm() {
		...
		if ($question_count != 0) {
			foreach ( $this->questions as $nr => $question ) {
				...
				$question_display = SurveyQuestionDisplay::factory ( $this, $question, $this->get_parent ()->get_question_visibility($question->get_id ()) ,$nr, $this->get_parent ()->get_survey () ,$this->get_parent ()->get_real_page_nr($this->page_number), $answer);
