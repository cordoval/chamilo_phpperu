...
class ScormImport extends ContentObjectImport
{
    ...
    {
        $title = $item['title'];
        $learning_path = ContentObject :: factory(LearningPath :: get_type_name());
    ...
    {
        $scorm_item = ContentObject :: factory(ScormItem :: get_type_name());
    ...
    {
        $learning_path_item = ContentObject :: factory(LearningPathItem :: get_type_name());
