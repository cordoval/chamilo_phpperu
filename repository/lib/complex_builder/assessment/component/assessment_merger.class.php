...
class AssessmentBuilderAssessmentMergerComponent extends AssessmentBuilderComponent
{
    ...
    function get_condition($selected_assessment)
    {
        ...
        $condition = new SubselectCondition(ContentObject :: PROPERTY_ID, ComplexContentObjectItem :: PROPERTY_REF, RepositoryDataManager :: get_instance()->get_database()->escape_table_name(ComplexContentObjectItem :: get_table_name()), $sub_condition, ContentObject :: get_table_name());
