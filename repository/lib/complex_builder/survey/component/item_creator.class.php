...
class SurveyBuilderItemCreatorComponent extends SurveyBuilderComponent
{
    private $rdm;
    ...
    function run()
    {
        ...
        else
        {
            ...
            {
                $content_object = new SurveyItem();
                $content_object->set_title('survey_item');
                $content_object->set_description('survey_item');
                ...
                $cloi = ComplexContentObjectItem :: factory('survey_item');
    ...
    private function retrieve_used_items($parent)
    {
        ...
        while ($cloi = $clois->next_result())
        {
            ...
            $object = $this->rdm->retrieve_content_object($cloi->get_ref());
            $items[] = $object->get_reference();
