 ...
 */
require_once dirname(__FILE__) . '/competence_content_object_table_data_provider.class.php';
require_once dirname(__FILE__) . '/competence_content_object_table_column_model.class.php';
require_once dirname(__FILE__) . '/competence_content_object_table_cell_renderer.class.php';
/**
 * This class represents a table with learning objects which are candidates for
 * publication.
 */
class CompetenceContentObjectTable extends ObjectTable
{
    const DEFAULT_NAME = 'competence_content_object_table';
     ...
     */
    function CompetenceContentObjectTable($parent, $owner, $types, $query, $table_actions)
    {
        $data_provider = new CompetenceContentObjectTableDataProvider($owner, $types, $query, $parent);
        $column_model = new CompetenceContentObjectTableColumnModel();
        $cell_renderer = new CompetenceContentObjectTableCellRenderer($table_actions);
        parent :: __construct($data_provider, CompetenceContentObjectTable :: DEFAULT_NAME, $column_model, $cell_renderer);
