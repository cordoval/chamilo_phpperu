...
class LearningPathBuilderPrerequisitesBuilderComponent extends LearningPathBuilderComponent
{
    ...
    function run()
    {
        ...
        $parameters = array(LearningPathBuilder :: PARAM_ROOT_LO => $this->get_root_lo()->get_id(), LearningPathBuilder :: PARAM_CLOI_ID => $parent_cloi, LearningPathBuilder :: PARAM_SELECTED_CLOI_ID => $cloi_id, 'publish' => Request :: get('publish'));
        ...
        else
        {
            ...
            $menu = new ComplexMenu($this->get_root_lo(), $this->get_cloi(), '', true, false);
