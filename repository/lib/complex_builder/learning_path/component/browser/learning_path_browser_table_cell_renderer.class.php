...
class LearningPathBrowserTableCellRenderer extends ComplexBrowserTableCellRenderer
{
    ...
    protected function get_modification_links($cloi, $lo)
    {
        ...
        if ($lo->get_type() == 'learning_path_item')
        {
            ...
            {
                $additional_items[] = array('href' => $this->browser->get_prerequisites_url($cloi->get_id()), 'label' => Translation :: get('BuildPrerequisites'), 'img' => Theme :: get_common_image_path() . 'action_maintenance.png');
            }
