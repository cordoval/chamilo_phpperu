    ...
    function run()
    {
        ...
        if ($type)
        {
            ...
            if ($lo_form->validate())
            {
                ...
                {
                    $parameters = array(Application :: PARAM_ACTION => RepositoryManager :: ACTION_BUILD_COMPLEX_CONTENT_OBJECT_ITEM, ComplexBuilder :: PARAM_ROOT_CONTENT_OBJECT => $object->get_id());
