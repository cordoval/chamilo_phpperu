        ...
        if ($this->check_content_object_from_params())
        {
            ...
            if (isset($export) && $export->get_enabled() == 1)
            {
                try
                {
                    ...
                    $form = ExternalRepositoryExportForm :: get_instance($content_object, $export, $this->get_url(array(RepositoryManager :: PARAM_EXTERNAL_REPOSITORY_ID => $export->get_id(), RepositoryManager :: PARAM_CONTENT_OBJECT_ID => $content_object->get_id())), null);
