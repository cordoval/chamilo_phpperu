 ...
 */
class RepositoryBrowserGalleryTable extends ObjectTable
{
    ...
    {
        $model = new RepositoryBrowserGalleryTableColumnModel();
        $renderer = new RepositoryBrowserGalleryTableCellRenderer($browser);
        $data_provider = new RepositoryBrowserGalleryTableDataProvider($browser, $condition);
        parent :: __construct($data_provider, RepositoryBrowserGalleryTable :: DEFAULT_NAME, $model, $renderer);
