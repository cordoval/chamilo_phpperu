<?php
/**
 * Description of RepositoryManagerStreamingVideoClipCreatorComponent class
 *
 * @author jevdheyd
 */
class RepositoryManagerStreamingVideoClipCreatorComponent extends RepositoryManagerComponent {
    ...
    function run()
    {
        ...
        if(is_null($streaming_video_clip->get_application()))
        {
            ...
            $condition1 = new EqualityCondition('variable', $streaming_video_clip :: STREAMING_VIDEO_ADMIN_SETTING);
            $condition2 = new EqualityCondition('value', $streaming_video_clip :: STREAMING_VIDEO_ADMIN_SETTING_VALUE);
            ...
            elseif(count($applications) > 1)
            {
                ...
                $select_form->addElement('select',$streaming_video_clip::PROPERTY_APPLICATION);
