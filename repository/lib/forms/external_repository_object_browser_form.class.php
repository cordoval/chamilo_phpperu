...
class ExternalRepositoryObjectBrowserForm extends FormValidator
{
    ...
    private function build_objects_list($objects_list)
    {
                ...
                if(isset($object[BaseExternalRepositoryConnector :: SYNC_STATE]))
                {
                    switch($object[BaseExternalRepositoryConnector :: SYNC_STATE])
                    {
                        case BaseExternalRepositoryConnector :: SYNC_NEVER_SYNCHRONIZED:
                            ...
                            $buttons[] = '<a href="' . $url . '"><img src="' . Theme :: get_common_image_path() . 'import_repository.png' . '" />' . Translation :: get('ExternalRepositoryImport') . '</a>';
                            break;
                        ...
                        case BaseExternalRepositoryConnector :: SYNC_NEWER_IN_CHAMILO:
                            ...
                            $buttons[] = '<a href="' . $url . '"><img src="' . Theme :: get_common_image_path() . 'export_repository.png' . '" />' . Translation :: get('ExternalRepositoryExport') . '</a>';
        ...
        {
            echo Translation :: get('ExternalRepositoryNoObjects');
        }
    }
