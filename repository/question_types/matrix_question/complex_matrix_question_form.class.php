...
class AssessmentComplexMatrixQuestionForm extends ComplexContentObjectItemForm
{
    ...
    {
        $elements[] = $this->createElement('text', AssessmentComplexMatrixQuestion :: PROPERTY_WEIGHT, Translation :: get('Weight'), array("size" => "50"));
        return $elements;
    }
    ...
    function get_default_values()
    {
        ...
        if (isset($cloi))
        {
            $defaults[AssessmentComplexMatrixQuestion :: PROPERTY_WEIGHT] = $cloi->get_weight() ? $cloi->get_weight() : 0;
        }
    ...
    function create_complex_content_object_item()
    {
        ...
        $cloi->set_weight($values[AssessmentComplexMatrixQuestion :: PROPERTY_WEIGHT]);
