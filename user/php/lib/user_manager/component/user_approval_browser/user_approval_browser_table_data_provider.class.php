 ...
 */
class UserApprovalBrowserTableDataProvider extends ObjectTableDataProvider
{
    ...
    function get_objects($offset, $count, $order_property = null)
    {
        ...
        return UserDataManager :: get_instance()->retrieve_approval_users($this->get_condition(), $offset, $count, $order_property);
    }
    ...
    {
        return UserDataManager :: get_instance()->count_approval_users($this->get_condition());
    }
}
?>