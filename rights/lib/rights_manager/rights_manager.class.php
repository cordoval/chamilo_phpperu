...
class RightsManager extends CoreApplication
{
    ...
    public function get_application_platform_admin_links()
    {
        ...
        $links[] = new DynamicAction(Translation :: get('TypeTemplates'), Translation :: get('TypeTemplatesDescription'), Theme :: get_image_path() . 'browse_type_template.png', $this->get_link(array(Application :: PARAM_ACTION => RightsManager :: ACTION_MANAGE_TYPE_TEMPLATES)));
