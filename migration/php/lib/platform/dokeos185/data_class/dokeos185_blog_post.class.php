...
class Dokeos185BlogPost extends Dokeos185CourseDataMigrationDataClass
{
    ...
    function is_valid()
    {
        if (!$this->get_id_reference($this->get_author_id(), 'main_database.user') || !$this->get_blog_id() || !($this->get_title() || $this->get_full_text()) || !$this->get_date_creation() || !$this->get_id_reference($this->get_blog_id(),  $this->get_database_name() . '.blog'))
        {
