...
class Dokeos185CourseRelUser extends Dokeos185MigrationDataClass
{
    ...
    function is_valid()
    {
        if (! $this->get_course_code() || ! $this->get_user_id() || $this->get_status() == NULL || $this->get_group_id() == NULL || $this->get_tutor_id() == NULL || $this->get_failed_element($this->get_course_code(), 'main_database.course') || $this->get_failed_element('main_database.user', $this->get_user_id()))
        {
