...
class DatabaseMigrationDataManager extends Database implements MigrationDataManagerInterface
{
    ...
    {
        return $this->retrieve_objects(FailedElement :: get_table_name(), $condition, $offset, $count, $order_property, FailedElement :: CLASS_NAME);
    }
    ...
    {
        return $this->retrieve_objects(FileRecovery :: get_table_name(), $condition, $offset, $count, $order_property, FileRecovery :: CLASS_NAME);
    }
    ...
    {
        return $this->retrieve_objects(IdReference :: get_table_name(), $condition, $offset, $count, $order_property, IdReference :: CLASS_NAME);
    }
    ...
    {
        return $this->retrieve_objects(MigrationBlockRegistration :: get_table_name(), $condition, $offset, $count, $order_property, MigrationBlockRegistration :: CLASS_NAME);
    }
