...
class MigrationManager extends CoreApplication
{
    ...
    {
        $links = array();
        $links[] = new DynamicAction(Translation :: get('Migrate'), Translation :: get('Migrate'), Theme :: get_image_path() . 'admin/sort.png', Redirect :: get_link(self :: APPLICATION_NAME, array(Application :: PARAM_ACTION => self :: ACTION_MIGRATE), array(), false, Redirect :: TYPE_CORE));
        $links[] = new DynamicAction(Translation :: get('SettingsCleaner'), Translation :: get('SettingsCleaner'), Theme :: get_image_path() . 'admin/sort.png', Redirect :: get_link(self :: APPLICATION_NAME, array(
