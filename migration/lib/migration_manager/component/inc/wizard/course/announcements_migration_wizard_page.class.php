<?php
/**
 * $Id: announcements_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class AnnouncementsMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Announcements');
            default :
                return Translation :: get('Announcements');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Announcements') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_announcements']) && $exportvalues['migrate_announcements'] == 1)
        {
            ...
            {
                echo (Translation :: get('Announcements') . ' ' . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Courses') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Announcements') . ' ' . Translation :: get('skipped') . '<br />');
