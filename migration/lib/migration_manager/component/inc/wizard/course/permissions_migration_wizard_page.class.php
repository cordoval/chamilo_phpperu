<?php
/**
 * $Id: permissions_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class PermissionsMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Permission_groups');
            case 1 :
                return Translation :: get('Permission_users');
            case 2 :
                return Translation :: get('Permission_tasks');
            default :
                return Translation :: get('Permission_groups');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Permissions') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_permissions']) && $exportvalues['migrate_permissions'] == 1)
        {
            ...
            {
                echo (Translation :: get('Permissions') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Permissions') . ' ' . Translation :: get('skipped') . '<br />');
