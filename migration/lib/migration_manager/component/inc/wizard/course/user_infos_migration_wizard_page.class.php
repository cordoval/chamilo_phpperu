<?php
/**
 * $Id: user_infos_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class UserinfosMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Userinfo_definitions');
            case 1 :
                return Translation :: get('Userinfo_contents');
            default :
                return Translation :: get('Userinfo_definitions');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Userinfos') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_userinfos']) && $exportvalues['migrate_userinfos'] == 1)
        {
            ...
            {
                echo (Translation :: get('Userinfos') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Userinfos') . ' ' . Translation :: get('skipped') . '<br />');
