<?php
/**
 * $Id: student_publications_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class StudentPublicationsMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Student_publications');
            default :
                return Translation :: get('Student_publications');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Student_publications') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_student_publications']) && $exportvalues['migrate_student_publications'] == 1)
        {
            ...
            {
                echo (Translation :: get('Student_publications') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Student_publications') . ' ' . Translation :: get('skipped') . '<br />');
