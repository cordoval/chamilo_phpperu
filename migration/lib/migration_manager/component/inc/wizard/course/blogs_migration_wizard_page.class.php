<?php
/**
 * $Id: blogs_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class BlogsMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Blogs');
            case 1 :
                return Translation :: get('Blog_comments');
            case 2 :
                return Translation :: get('Blog_posts');
            case 3 :
                return Translation :: get('Blog_ratings');
            case 4 :
                return Translation :: get('Blog_rel_users');
            case 5 :
                return Translation :: get('Blog_tasks');
            case 6 :
                return Translation :: get('Blog_task_rel_users');
            default :
                return Translation :: get('Blogs');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Blogs') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_blogs']) && $exportvalues['migrate_blogs'] == 1)
        {
            ...
            {
                echo (Translation :: get('Blogs') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Blogs') . ' ' . Translation :: get('skipped') . '<br />');
