<?php
/**
 * $Id: forums_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class ForumsMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Forum_categories');
            case 1 :
                return Translation :: get('Forums');
            case 2 :
                return Translation :: get('Forum_threads');
            case 3 :
                return Translation :: get('Forum_posts');
            case 4 :
                return Translation :: get('Forum_mailcues');
            default :
                return Translation :: get('Forum_categories');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Forums') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_forums']) && $exportvalues['migrate_forums'] == 1)
        {
            ...
            {
                echo (Translation :: get('Forums') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Forums') . ' ' . Translation :: get('skipped') . '<br />');
