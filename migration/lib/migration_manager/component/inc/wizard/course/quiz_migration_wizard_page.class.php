<?php
/**
 * $Id: quiz_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class QuizMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Quizzes');
            case 1 :
                return Translation :: get('Quiz_questions');
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Quizzes') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_quizzes']) && $exportvalues['migrate_quizzes'] == 1)
        {
            ...
            {
                echo (Translation :: get('Quizzes') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Quizzes') . ' ' . Translation :: get('skipped') . '<br />');
