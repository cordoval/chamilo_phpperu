<?php
/**
 * $Id: surveys_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class SurveysMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Surveys');
            case 1 :
                return Translation :: get('Survey_questions');
            case 2 :
                return Translation :: get('Survey_question_options');
            case 3 :
                return Translation :: get('Survey_answers');
            default :
                return Translation :: get('Surveys');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Surveys') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_surveys']) && $exportvalues['migrate_surveys'] == 1)
        {
            ...
            {
                echo (Translation :: get('Surveys') . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Surveys') . ' ' . Translation :: get('skipped') . '<br />');
