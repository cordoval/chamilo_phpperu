<?php
/**
 * $Id: links_migration_wizard_page.class.php 221 2009-11-13 14:36:41Z vanpouckesven $
...
class LinksMigrationWizardPage extends MigrationWizardPage
{
    ...
    function get_message($index)
    {
        ...
        {
            case 0 :
                return Translation :: get('Link_categories');
            case 1 :
                return Translation :: get('Links');
            default :
                return Translation :: get('Link_categories');
        }
    }
    ...
    function perform()
    {
        ...
        {
            echo (Translation :: get('Links') . ' ' . Translation :: get('already_migrated') . '<br />');
            return false;
        }
        ...
        if (isset($exportvalues['migrate_links']) && $exportvalues['migrate_links'] == 1)
        {
            ...
            {
                echo (Translation :: get('Link_categories') . ' and ' . Translation :: get('Links') . ' ' . Translation :: get('failed') . ' ' . Translation :: get('because') . ' ' . Translation :: get('Users') . ' ' . Translation :: get('skipped') . '<br />');
        ...
        {
            echo (Translation :: get('Links') . ' ' . Translation :: get('skipped') . '<br />');
