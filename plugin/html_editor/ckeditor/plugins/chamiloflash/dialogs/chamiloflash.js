...
(function()
{
	...
	var names = [ 'play', 'loop', 'menu', 'quality', 'scale', 'salign', 'wmode', 'bgcolor', 'base', 'chamiloflashvars', 'allowScriptAccess',
		'allowFullScreen' ];
	...
	CKEDITOR.dialog.add( 'chamiloflash', function( editor )
	{
		var makeObjectTag = !editor.config.chamiloflashEmbedTagOnly,
			makeEmbedTag = editor.config.chamiloflashAddEmbedTag || editor.config.chamiloflashEmbedTagOnly;
		...
		return {
			...
			onShow : function()
			{
				...
				if ( fakeImage && fakeImage.getAttribute( '_cke_real_element_type' ) && fakeImage.getAttribute( '_cke_real_element_type' ) == 'chamiloflash' )
				{
			...
			onOk : function()
			{
				...
				// Apply or remove chamiloflash parameters.
				var extraStyles = {};
				this.commitContent( objectNode, embedNode, paramMap, extraStyles );

				// Refresh the fake image.
				var newFakeImage = editor.createFakeElement( objectNode || embedNode, 'cke_chamiloflash', 'chamiloflash', true );
			...
			contents : [
									...
									[
										{
											...
											type : 'text',
											label : '',
											validate : CKEDITOR.dialog.validate.notEmpty( editor.lang.chamiloflash.validateSrc ),
											setup : loadValue,
											commit : commitValue,
											onLoad : function()
											{
							...
							[
								{
									...
									id : 'width',
									style : 'width:95px',
									label : editor.lang.chamiloflash.width,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflash.validateWidth ),
								...
								},
								{
									...
									id : 'height',
									style : 'width:95px',
									label : editor.lang.chamiloflash.height,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflash.validateHeight ),
									setup : function( objectNode, embedNode, paramMap, fakeImage )
									{
										loadValue.apply( this, arguments );
										if ( fakeImage )
								...
								},
								{
									...
									id : 'hSpace',
									style : 'width:95px',
									label : editor.lang.chamiloflash.hSpace,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflash.validateHSpace ),
									setup : loadValue,
									commit : commitValue
								},
								{
									...
									id : 'vSpace',
									style : 'width:95px',
									label : editor.lang.chamiloflash.vSpace,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflash.validateVSpace ),
									setup : loadValue,
									commit : commitValue
								}
							]
				...
				{
					id : 'properties',
					label : editor.lang.chamiloflash.propertiesTab,
					elements :
					[
						{
							type : 'hbox',
							...
							[
								{
									id : 'scale',
									type : 'select',
									label : editor.lang.chamiloflash.scale,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , ''],
										[ editor.lang.chamiloflash.scaleAll, 'showall' ],
										[ editor.lang.chamiloflash.scaleNoBorder, 'noborder' ],
										[ editor.lang.chamiloflash.scaleFit, 'exactfit' ]
									],
									setup : loadValue,
									commit : commitValue
								},
								{
									...
									type : 'select',
									label : editor.lang.chamiloflash.access,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , ''],
										[ editor.lang.chamiloflash.accessAlways, 'always' ],
										[ editor.lang.chamiloflash.accessSameDomain, 'samedomain' ],
										[ editor.lang.chamiloflash.accessNever, 'never' ]
									],
									setup : loadValue,
									commit : commitValue
								}
							...
							[
								{
									id : 'wmode',
									type : 'select',
									label : editor.lang.chamiloflash.windowMode,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , '' ],
										[ editor.lang.chamiloflash.windowModeWindow, 'window' ],
										[ editor.lang.chamiloflash.windowModeOpaque, 'opaque' ],
										[ editor.lang.chamiloflash.windowModeTransparent, 'transparent' ]
									],
									setup : loadValue,
									commit : commitValue
								},
								{
									id : 'quality',
									type : 'select',
									label : editor.lang.chamiloflash.quality,
									'default' : 'high',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , '' ],
										[ editor.lang.chamiloflash.qualityBest, 'best' ],
										[ editor.lang.chamiloflash.qualityHigh, 'high' ],
										[ editor.lang.chamiloflash.qualityAutoHigh, 'autohigh' ],
										[ editor.lang.chamiloflash.qualityMedium, 'medium' ],
										[ editor.lang.chamiloflash.qualityAutoLow, 'autolow' ],
										[ editor.lang.chamiloflash.qualityLow, 'low' ]
									],
									setup : loadValue,
									commit : commitValue
								}
							...
							[
								{
									id : 'align',
									type : 'select',
									label : editor.lang.chamiloflash.align,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , ''],
										[ editor.lang.chamiloflash.alignLeft , 'left'],
										[ editor.lang.chamiloflash.alignAbsBottom , 'absBottom'],
										[ editor.lang.chamiloflash.alignAbsMiddle , 'absMiddle'],
										[ editor.lang.chamiloflash.alignBaseline , 'baseline'],
										[ editor.lang.chamiloflash.alignBottom , 'bottom'],
										[ editor.lang.chamiloflash.alignMiddle , 'middle'],
										[ editor.lang.chamiloflash.alignRight , 'right'],
										[ editor.lang.chamiloflash.alignTextTop , 'textTop'],
										[ editor.lang.chamiloflash.alignTop , 'top']
									],
									setup : loadValue,
									commit : commitValue
								},
						...
						},
						{
							...
							[
								{
									type : 'html',
									html : CKEDITOR.tools.htmlEncode( editor.lang.chamiloflash.chamiloflashvars )
								},
								{
									type : 'checkbox',
									id : 'menu',
									label : editor.lang.chamiloflash.chkMenu,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								},
								{
									type : 'checkbox',
									id : 'play',
									label : editor.lang.chamiloflash.chkPlay,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								},
								{
									type : 'checkbox',
									id : 'loop',
									label : editor.lang.chamiloflash.chkLoop,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								},
								{
									type : 'checkbox',
									id : 'allowFullScreen',
									label : editor.lang.chamiloflash.chkFull,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								}
							...
							[
								{
									type : 'text',
									id : 'bgcolor',
									label : editor.lang.chamiloflash.bgcolor,
									setup : loadValue,
									commit : commitValue
								},
								{
