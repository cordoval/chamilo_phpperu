 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Gdata_Docs_DocumentAclFeed extends Zend_Gdata_Feed
{
     ...
     * @var string
     */
    protected $_entryClassName = 'Zend_Gdata_Docs_DocumentAclEntry';
     ...
     * @var string
     */
    protected $_feedClassName = 'Zend_Gdata_Docs_DocumentAclFeed';
