...
class ReportingManagerViewComponent extends ReportingManagerComponent
{
    ...
    function run()
    {
        ...
        $trail->add(new Breadcrumb($this->get_url(array(Application :: PARAM_ACTION => ReportingManager :: ACTION_VIEW_TEMPLATE, ReportingManager :: PARAM_TEMPLATE_ID => $template)), Translation :: get($reporting_template_registration->get_template())));
