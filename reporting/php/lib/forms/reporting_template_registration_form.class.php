...
class ReportingTemplateRegistrationForm extends FormValidator
{
    ...
    {
        $this->addElement('text', ReportingTemplateRegistration :: PROPERTY_TITLE, Translation :: get('Title', null, Utilities :: COMMON_LIBRARIES), array("size" => "50"));
        $this->addRule(ReportingTemplateRegistration :: PROPERTY_TITLE, Translation :: get('ThisFieldIsRequired', null, Utilities :: COMMON_LIBRARIES), 'required');

        $this->add_html_editor(ReportingTemplateRegistration :: PROPERTY_DESCRIPTION, Translation :: get('Description', null, Utilities :: COMMON_LIBRARIES), true);
    }
