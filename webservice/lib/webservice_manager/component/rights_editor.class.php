 ...
 * the repository.
 */
class WebserviceManagerRightsEditorComponent extends WebserviceManager
{
	function run()
	{
        ...
        {
        	$locations[] = WebserviceRights :: get_location_id_by_identifier_from_webservices_subtree(WebserviceRights :: TYPE_WEBSERVICE, $webservice);
        }
        ...
        if(count($locations) == 0)
        {
        	if ($category)
        	{
        		$locations[] = WebserviceRights :: get_location_id_by_identifier_from_webservices_subtree(WebserviceRights :: TYPE_WEBSERVICE_CATEGORY, $category);
        	}
        	else
        	{
