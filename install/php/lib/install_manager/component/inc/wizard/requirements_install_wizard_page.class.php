...
class RequirementsInstallWizardPage extends InstallWizardPage
{
    ...
    function get_data()
    {
        ...
        $extensions = array('gd' => 'http://www.php.net/gd', 'pcre' => 'http://www.php.net/pcre', 'session' => 'http://www.php.net/session', 'standard' => 'http://www.php.net/spl', 'zlib' => 'http://www.php.net/zlib', 'xsl' => 'http://www.php.net/xsl', 'mbstring' => 'http://www.php.net/mbstring' /*, 'openssl' => 'http://www.php.net/openssl', 'curl' => 'http://www.php.net/curl'*/);
