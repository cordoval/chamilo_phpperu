...
class PreconfiguredInstallWizardPage extends InstallWizardPage
{
    ...
    function buildForm()
    {
        ...
        $buttons = array();
        $buttons[] = $this->createElement('style_submit_button', '_qf_page_language_jump', Translation :: get('Back', null, Utilities :: COMMON_LIBRARIES), array('class' => 'normal previous'));
        $buttons[] = $this->createElement('style_submit_button', $this->getButtonName('next'), Translation :: get('Finish', null, Utilities :: COMMON_LIBRARIES), array('class' => 'normal next'));
