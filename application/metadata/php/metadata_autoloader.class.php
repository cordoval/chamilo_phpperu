...
class MetadataAutoloader
{
    static function load($classname)
    {
        ...
        'metadata_editor_form' => 'forms/metadata_editor_form.class.php',
        ...
        'metadata_property_value_browser_table' => 'metadata_manager/component/metadata_property_value_browser/metadata_property_value_browser_table.class.php',
