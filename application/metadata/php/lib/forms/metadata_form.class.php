...
class MetadataForm extends FormValidator
{
    ...
    function edit_metadata_property_values()
    {
        ...
        foreach($this->metadata_property_values as $metadata_property_value)
        {
            ...
            if($values[MetadataPropertyAttributeValue :: PROPERTY_PROPERTY_ATTRIBUTE_TYPE_ID . '_' . $metadata_property_value->get_id()] != self :: OPTION_BLANK)
            {
                ...
                $metadata_property_attribute_value->set_property_attribute_type_id($values[MetadataPropertyAttributeValue :: PROPERTY_PROPERTY_ATTRIBUTE_TYPE_ID . '_' . $metadata_property_value->get_id()]);
        ...
        {
            if($values[$content_object_property->get_content_object_property() . '_' . MetadataManager :: PARAM_METADATA_PROPERTY_ATTRIBUTE_VALUE] != self :: OPTION_BLANK)
            {
                $metadata_property_attribute_value = new MetadataPropertyAttributeValue();

                $metadata_property_attribute_value->set_parent_id($this->content_object->get_id());
                $metadata_property_attribute_value->set_property_attribute_type_id($values[$content_object_property->get_content_object_property() . '_' . MetadataManager :: PARAM_METADATA_PROPERTY_ATTRIBUTE_VALUE]);
...
//    function create_metadata_property_values()
//    {
//    	$values = $this->exportValues();
//
//        $metadata_property_value = $this->metadata_property_value;
//
//        $metadata_property_value->set_content_object_id($values[MetadataPropertyValue :: PROPERTY_CONTENT_OBJECT_ID]);
//    	$metadata_property_value->set_property_type_id($values[MetadataPropertyValue :: PROPERTY_PROPERTY_TYPE_ID]);
//    	$metadata_property_value->set_value($values[MetadataPropertyValue :: PROPERTY_VALUE]);
...
//    }
    ...
    function setDefaults($defaults = array ())
    {
        ...
        {
            $defaults[$this->content_object_property_metadata_values[$metadata_property_attribute_value->get_parent_id()]->get_content_object_property() . '_' . MetadataManager :: PARAM_METADATA_PROPERTY_ATTRIBUTE_VALUE . '_' . $id] = $metadata_property_attribute_value->get_property_attribute_type_id();
        }
        ...
        foreach($this->metadata_property_values as $metadata_property_value)
        {
            ...
            {
                $defaults[MetadataPropertyAttributeValue :: PROPERTY_PROPERTY_ATTRIBUTE_TYPE_ID . '_' . $metadata_property_value->get_id() . '_' . $metadata_property_attribute_value->get_id()] = $metadata_property_attribute_value->get_property_attribute_type_id();
            }
        }
    ...
    function build_content_object_property_metadata_values()
    {
        ...
        foreach($this->content_object_property_metadata_values as $id => $content_object_property)
        {
            ...
            if(method_exists(ContentObject :: CLASS_NAME, $function_name))
            {
                ...
                $this->addElement('static','',$this->property_types[$content_object_property->get_property_type_id()] ,$this->content_object->$function_name());
                $this->addElement('select', $content_object_property->get_content_object_property() . '_' . MetadataManager :: PARAM_METADATA_PROPERTY_ATTRIBUTE_VALUE, Translation :: get('NewPropertyAttributeType'), $this->filter_allowed_property_attribute_types($content_object_property->get_property_type_id()));
    ...
    function build_metadata_property_values()
    {
        ...
        foreach($this->metadata_property_values as $metadata_property_value)
        {
            ...
            {
                $this->addElement('select', MetadataPropertyAttributeValue :: PROPERTY_PROPERTY_ATTRIBUTE_TYPE_ID . '_' . $metadata_property_value->get_id(), Translation :: get('NewPropertyAttributeType'), $this->filter_allowed_property_attribute_types($metadata_property_value->get_property_type_id()));
    ...
    function build_content_object_property_metadata_attribute_values($property_type_id, $content_object_property)
    {
        foreach($this->metadata_property_attribute_values[MetadataPropertyAttributeValue :: RELATION_CONTENT_OBJECT_PROPERTY][$this->content_object->get_id()] as $id => $metadata_property_attribute_value)
        {
            if($this->content_object_property_metadata_values[$metadata_property_attribute_value->get_parent_id()]->get_content_object_property() == $content_object_property)
            {
                ...
                $group[] = $this->createElement('select', $content_object_property . '_' . MetadataManager :: PARAM_METADATA_PROPERTY_ATTRIBUTE_VALUE . '_' . $id , Translation :: get('PropertyAttributeType'), $this->filter_allowed_property_attribute_types($property_type_id));
                ...
                $this->addGroup($group, '', Translation :: get('PropertyAttributeType'));
            }
        }
    }
    ...
    {
        foreach($this->metadata_property_attribute_values[$metadata_property_value->get_id()] as $n => $metadata_property_attribute_value)
        {
    ...
    function get_property_attribute_types()
    {
        ...
        {
            switch ($property_attribute_type->get_value_type())
            {
                case MetadataPropertyAttributeType :: VALUE_TYPE_NONE:
                    $value = '';
                    break;
                 case MetadataPropertyAttributeType :: VALUE_TYPE_ID:
                     $value = '=' . $types[$property_attribute_type->get_value()]->render_name();
                     break;
                 case MetadataPropertyAttributeType :: VALUE_TYPE_NONE:
                    $value = '=' . $property_attribute_type->get_value();
                     break;
            }
            $this->property_attribute_types[$property_attribute_type->get_id()] = $property_attribute_type->render_name($property_attribute_type) . $value;
        }
    }
