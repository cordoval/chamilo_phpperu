...
class MetadataManagerMetadataPropertyAttributeTypesBrowserComponent extends MetadataManager
{
    ...
    function run()
    {
        ...
        $trail->add(new BreadCrumb($this->get_url(), Translation :: get('BrowseObjects', array('OBJECTS' => Translation :: get('MetadataPropertyAttributeTypes')), Utilities :: COMMON_LIBRARIES)));
