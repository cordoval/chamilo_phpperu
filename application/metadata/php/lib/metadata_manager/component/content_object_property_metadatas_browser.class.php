...
class MetadataManagerContentObjectPropertyMetadatasBrowserComponent extends MetadataManager
{
    ...
    function get_action_bar()
    {
       $action_bar = new ActionBarRenderer(ActionBarRenderer :: TYPE_HORIZONTAL);
        ...
        $actions = array();
        $actions[] = new ToolbarItem(Translation :: get('CreateObject', array('OBJECT' => Translation :: get('ContentObjectPropertyMetadata')), Utilities :: COMMON_LIBRARY), Theme :: get_common_image_path() . 'action_create.png', $this->get_url(array(MetadataManager :: PARAM_ACTION => MetadataManager :: ACTION_CREATE_CONTENT_OBJECT_PROPERTY_METADATA)));
