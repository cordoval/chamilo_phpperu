...
//         return implode ("\n", $html);
    ...
    function get_action_bar()
    {
        ...
        if ($this->edit_right)
        {
            ...
            $actions[] = new ToolbarItem(Translation :: get('MakeOdf'), Theme :: get_image_path() . 'odt.png', $this->get_url(array(Application::PARAM_APPLICATION => self::APPLICATION_NAME, self :: PARAM_ACTION => self :: ACTION_CREATE_ODF, self :: PARAM_HANDBOOK_PUBLICATION_ID => $this->handbook_publication_id, self::PARAM_HANDBOOK_ID => $this->handbook_id)));
            $actions[] = new ToolbarItem(Translation :: get('Export'), Theme :: get_common_image_path() . 'action_export.png', $this->get_url(array(Application::PARAM_APPLICATION => self::APPLICATION_NAME, self :: PARAM_ACTION => self :: ACTION_EXPORT, self :: PARAM_HANDBOOK_ID => $this->handbook_id)));
