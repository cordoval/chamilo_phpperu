    ...
    function run()
    {
        if ($this->is_allowed(WeblcmsRights :: EDIT_RIGHT))
        {
            ...
            if ($form->validate())
            {
                ...
                {
                    $message = Translation :: get('ObjectMoved', array('OBJECT' => Translation :: get('Publication')),Utilities:: COMMON_LIBRARIES);
                }
                else
                {
                    $message = Translation :: get('ObjectsMoved', array('OBJECTS' => Translation :: get('Publications')),Utilities:: COMMON_LIBRARIES);
                }
