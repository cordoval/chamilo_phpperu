 ...
 */
class YearCalendarContentObjectPublicationListRenderer extends CalendarContentObjectPublicationListRenderer
{
    ...
    function as_html()
    {
        $calendar_table = new YearCalendar($this->get_display_time());
