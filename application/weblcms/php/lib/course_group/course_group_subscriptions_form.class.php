...
class CourseGroupSubscriptionsForm extends FormValidator
{
    ...
    function __construct($course_group, $action, $parent)
    {
    ...
    function build_basic_form()
    {
        ...
        $url = Path :: get(WEB_PATH) . 'application/weblcms/php/xml_feeds/xml_course_user_group_feed.php?course=' . $this->parent->get_course_id();
