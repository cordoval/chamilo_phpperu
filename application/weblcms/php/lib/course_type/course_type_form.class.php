...
class CourseTypeForm extends CommonForm
{
    ...
    function build_general_settings_form()
    {
        ...
        $this->registerRule('max_members', null, 'application\weblcms\HTML_QuickForm_Rule_Max_Members', dirname(__FILE__) . '/max_members_rule.class.php');
        ...
        for($i = 0; $i < 2; $i ++)
        {
            ...
            switch ($i)
            {
                case 0 :
                    ...
                    break;
                case 1 :
                    $target = self :: CREATION_ON_REQUEST_ELEMENTS;
