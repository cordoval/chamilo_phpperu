...
class WeblcmsPublicationRSS extends PublicationRSS
{
    ...
    function add_item($publication, $channel)
    {
        ...
        $description .= '<b>' . Translation :: get('Published') . ': </b>' . DatetimeUtilities :: format_locale_date(Translation :: get('DateFormatShort', null ,Utilies:: COMMON_LIBRARIES) . ', ' . Translation :: get('TimeNoSecFormat', null ,Utilies:: COMMON_LIBRARIES), $publication->get_publication_date()) . '<br />';
