...
class WeblcmsManagerCourseChangeCourseTypeComponent extends WeblcmsManager
{
    ...
    function add_additional_breadcrumbs(BreadcrumbTrail $breadcrumbtrail)
    {
        ...
        if ($this->get_user()->is_platform_admin())
        {
            ...
            $breadcrumbtrail->add(new Breadcrumb($this->get_url(array(WeblcmsManager :: PARAM_ACTION => WeblcmsManager :: ACTION_ADMIN_COURSE_BROWSER), array(WeblcmsManager :: PARAM_COURSE)), Translation :: get('CourseList')));
        }
        else
        {
