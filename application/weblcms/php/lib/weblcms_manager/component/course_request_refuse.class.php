    ...
    function run()
    {
        ...
        if (! is_null($request_ids) && $this->get_user()->is_platform_admin())
        {
            ...
            $this->redirect(Translation :: get($message), ($failures ? true : false), array(
                    Application :: PARAM_ACTION => WeblcmsManager :: ACTION_ADMIN_REQUEST_BROWSER, WeblcmsManager :: PARAM_REQUEST => null, WeblcmsManager :: PARAM_REQUEST_TYPE => $request_type, WeblcmsManager :: PARAM_REQUEST_VIEW => WeblcmsManagerAdminRequestBrowserComponent :: DENIED_REQUEST_VIEW));
        }
        else
        {
