...
abstract class CommonForm extends FormValidator
{
    ...
    function __construct($form_type, $object, $action, $parent, $form_name, $method)
    {
        ...
        $this->setDefaults();
        $this->addElement('html', ResourceManager :: get_instance()->get_resource_html(Path :: get(WEB_APP_PATH) . 'weblcms/resources/javascript/weblcms_common_form.js'));
        $this->addElement('html', ResourceManager :: get_instance()->get_resource_html(Path :: get(WEB_LIB_PATH) . 'libraries/resources/javascript/viewable_checkbox.js'));
    }
    ...
    function fill_subscribe_rights()
    {
        ...
        for($i = 0; $i < 3; $i ++)
        {
            ...
            {
                case 0 :
                    $target = self :: SUBSCRIBE_DIRECT_TARGET_ELEMENTS;
                    ...
                    break;
                case 1 :
                    $target = self :: SUBSCRIBE_REQUEST_TARGET_ELEMENTS;
                    ...
                    break;
                case 2 :
                    $target = self :: SUBSCRIBE_CODE_TARGET_ELEMENTS;
