...
class CourseForm extends CommonForm
{
    ...
    function build_basic_form()
    {
        ...
        $tabs_generator->add_tab(new DynamicFormTab('general', 'General', null, 'build_general_settings_form'));
        $tabs_generator->add_tab(new DynamicFormTab('layout', 'Layout', null, 'build_layout_form'));

        if ($this->form_type == self :: TYPE_CREATE)
        {
            $tabs_generator->add_tab(new DynamicFormTab('tools', 'Tools', null, 'build_tools_form'));
        }

        $tabs_generator->add_tab(new DynamicFormTab('rights', 'Rights', null, 'build_rights_form'));
    ...
    function build_general_settings_form()
    {
        ...
        else
        {
            ...
            $this->registerRule('max_members', null, 'application\weblcms\HTML_QuickForm_Rule_Max_Members', dirname(__FILE__) . '/../course_type/max_members_rule.class.php');
    ...
    function build_rights_form()
    {
        ...
        for($i = 0; $i < 3; $i ++)
        {
            ...
            {
                case 0 :
                    $constant_available = CourseRights :: PROPERTY_DIRECT_SUBSCRIBE_AVAILABLE;
                    ...
                    break;
                case 1 :
                    $constant_available = CourseRights :: PROPERTY_REQUEST_SUBSCRIBE_AVAILABLE;
                    ...
                    break;
                case 2 :
                    $constant_available = CourseRights :: PROPERTY_CODE_SUBSCRIBE_AVAILABLE;
