...
class CommonRequest extends DataClass
{
    ...
    {
        return parent :: get_default_property_names(array_merge($extended_property_names, array(self :: PROPERTY_USER_ID, self :: PROPERTY_SUBJECT, self :: PROPERTY_MOTIVATION, self :: PROPERTY_CREATION_DATE, self :: PROPERTY_DECISION_DATE, self :: PROPERTY_DECISION)));
    }
