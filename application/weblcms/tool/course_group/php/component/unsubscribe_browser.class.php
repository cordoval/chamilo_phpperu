...
class CourseGroupToolUnsubscribeBrowserComponent extends CourseGroupTool
{
    ...
    function run()
    {
        ...
        $table = new CourseGroupSubscribedUserBrowserTable($this, array(
                Application :: PARAM_APPLICATION => WeblcmsManager :: APPLICATION_NAME, Application :: PARAM_ACTION => WeblcmsManager :: ACTION_VIEW_COURSE, WeblcmsManager :: PARAM_COURSE => $this->get_course()->get_id(), WeblcmsManager :: PARAM_TOOL => $this->get_tool_id(),
                Tool :: PARAM_ACTION => CourseGroupTool :: ACTION_UNSUBSCRIBE, CourseGroupTool :: PARAM_COURSE_GROUP => $course_group_id), $this->get_condition());
