<?php
/**
 * $Id: day_calendar_content_object_publication_list_renderer.class.php 216 2009-11-13 14:08:06Z kariboe $
 ...
 */
class DayCalendarContentObjectPublicationListRenderer extends CalendarContentObjectPublicationListRenderer
{
    ...
    function as_html()
    {
        $calendar_table = new DayCalendar($this->get_display_time());
