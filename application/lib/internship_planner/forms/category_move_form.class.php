...
class InternshipPlannerCategoryMoveForm extends FormValidator
{
    ...
    function InternshipPlannerCategoryMoveForm($category, $action, $user)
    {
    ...
    function get_categories()
    {
        ...
        $category_menu = new InternshipPlannerCategoryMenu($category->get_id(), null, true, true);
