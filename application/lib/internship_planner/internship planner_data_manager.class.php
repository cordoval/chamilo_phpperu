<?php
/**
 *	This is a skeleton for a data manager for the Internship planner Application.
 *	Data managers must extend this class and implement its abstract methods.
 *
 *  @author Sven Vanpoucke
 *	@author ehb
 */
abstract class Internship plannerDataManager
{
	/**
	 ...
	 * Constructor.
	 */
	protected function Internship plannerDataManager()
	{
		$this->initialize();
	}
	 ...
	 * be instantiated.
	 * @return Internship plannerDataManager The data manager.
	 */
	static function get_instance()
	{
		if (!isset (self :: $instance))
		{
			...
			$class = $type.'Internship plannerDataManager';
	...
	abstract function get_next_location_id();
	abstract function create_location($location);
	abstract function update_location($location);
	abstract function delete_location($location);
	...
	abstract function get_next_location_group_id();
	abstract function create_location_group($location_group);
	abstract function update_location_group($location_group);
	abstract function delete_location_group($location_group);
	abstract function count_location_groups($conditions = null);
	abstract function retrieve_location_group($id);
	abstract function retrieve_location_groups($condition = null, $offset = null, $count = null, $order_property = null);
