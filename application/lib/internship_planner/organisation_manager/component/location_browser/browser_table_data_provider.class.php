...
class InternshipPlannerLocationBrowserTableDataProvider extends ObjectTableDataProvider
{
     ...
     */
    function InternshipPlannerLocationBrowserTableDataProvider($browser, $condition)
    {
