 ...
 */
class InternshipPlannerCategoryBrowserTableCellRenderer extends DefaultInternshipPlannerCategoryTableCellRenderer
{
    /**
     ...
     */
    function InternshipPlannerCategoryBrowserTableCellRenderer($browser)
    {
        parent :: __construct();
    ...
    {
        if ($column === InternshipPlannerCategoryBrowserTableColumnModel :: get_modification_column())
        {
