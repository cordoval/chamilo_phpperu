 ...
 */
class InternshipPlannerCategoryBrowserTableColumnModel extends DefaultInternshipPlannerCategoryTableColumnModel
{
    /**
     ...
     * Constructor
     */
    function InternshipPlannerCategoryBrowserTableColumnModel()
    {
        parent :: __construct();
