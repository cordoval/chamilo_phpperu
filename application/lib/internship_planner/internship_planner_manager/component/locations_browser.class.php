...
/**
 * internship_planner component which allows the user to browse his locations
 * @author Sven Vanpoucke
 * @author Sven Vanhoecke
 */
class InternshipPlannerManagerLocationsBrowserComponent extends InternshipPlannerManagerComponent
{
