<?php
/**
 * @package application.lib.internship planner.internship planner_manager
 */
...
/**
 * A internship planner manager
 *
 * @author Sven Vanpoucke
 * @author ehb
 */
 class Internship plannerManager extends WebApplication
 {
 	const APPLICATION_NAME = 'internship planner';
	 ...
	 */
    function Internship plannerManager($user = null)
    {
    ...
    /**
	 * Run this internship planner manager
	 */
	function run()
	{
		...
		switch ($action)
		{
			case self :: ACTION_BROWSE_CATEGORIES :
				$component = Internship plannerManagerComponent :: factory('CategoriesBrowser', $this);
				break;
			case self :: ACTION_DELETE_CATEGORY :
				$component = Internship plannerManagerComponent :: factory('CategoryDeleter', $this);
				break;
			case self :: ACTION_EDIT_CATEGORY :
				$component = Internship plannerManagerComponent :: factory('CategoryUpdater', $this);
				break;
			case self :: ACTION_CREATE_CATEGORY :
				$component = Internship plannerManagerComponent :: factory('CategoryCreator', $this);
				break;
			case self :: ACTION_BROWSE_LOCATIONS :
				$component = Internship plannerManagerComponent :: factory('LocationsBrowser', $this);
				break;
			case self :: ACTION_DELETE_LOCATION :
				$component = Internship plannerManagerComponent :: factory('LocationDeleter', $this);
				break;
			case self :: ACTION_EDIT_LOCATION :
				$component = Internship plannerManagerComponent :: factory('LocationUpdater', $this);
				break;
			case self :: ACTION_CREATE_LOCATION :
				$component = Internship plannerManagerComponent :: factory('LocationCreator', $this);
				break;
			case self :: ACTION_BROWSE_LOCATION_GROUPS :
				$component = Internship plannerManagerComponent :: factory('LocationGroupsBrowser', $this);
				break;
			case self :: ACTION_DELETE_LOCATION_GROUP :
				$component = Internship plannerManagerComponent :: factory('LocationGroupDeleter', $this);
				break;
			case self :: ACTION_EDIT_LOCATION_GROUP :
				$component = Internship plannerManagerComponent :: factory('LocationGroupUpdater', $this);
				break;
			case self :: ACTION_CREATE_LOCATION_GROUP :
				$component = Internship plannerManagerComponent :: factory('LocationGroupCreator', $this);
				break;
			case self :: ACTION_BROWSE_LOCATION_REL_CATEGORIES :
				$component = Internship plannerManagerComponent :: factory('LocationRelCategoriesBrowser', $this);
				break;
			case self :: ACTION_DELETE_LOCATION_REL_CATEGORY :
				$component = Internship plannerManagerComponent :: factory('LocationRelCategoryDeleter', $this);
				break;
			case self :: ACTION_EDIT_LOCATION_REL_CATEGORY :
				$component = Internship plannerManagerComponent :: factory('LocationRelCategoryUpdater', $this);
				break;
			case self :: ACTION_CREATE_LOCATION_REL_CATEGORY :
				$component = Internship plannerManagerComponent :: factory('LocationRelCategoryCreator', $this);
				break;
			case self :: ACTION_BROWSE_LOCATION_REL_MENTORS :
				$component = Internship plannerManagerComponent :: factory('LocationRelMentorsBrowser', $this);
				break;
			case self :: ACTION_DELETE_LOCATION_REL_MENTOR :
				$component = Internship plannerManagerComponent :: factory('LocationRelMentorDeleter', $this);
				break;
			case self :: ACTION_EDIT_LOCATION_REL_MENTOR :
				$component = Internship plannerManagerComponent :: factory('LocationRelMentorUpdater', $this);
				break;
			case self :: ACTION_CREATE_LOCATION_REL_MENTOR :
				$component = Internship plannerManagerComponent :: factory('LocationRelMentorCreator', $this);
				break;
			case self :: ACTION_BROWSE_LOCATION_REL_MOMENTS :
				$component = Internship plannerManagerComponent :: factory('LocationRelMomentsBrowser', $this);
				break;
			case self :: ACTION_DELETE_LOCATION_REL_MOMENT :
				$component = Internship plannerManagerComponent :: factory('LocationRelMomentDeleter', $this);
				break;
			case self :: ACTION_EDIT_LOCATION_REL_MOMENT :
				$component = Internship plannerManagerComponent :: factory('LocationRelMomentUpdater', $this);
				break;
			case self :: ACTION_CREATE_LOCATION_REL_MOMENT :
				$component = Internship plannerManagerComponent :: factory('LocationRelMomentCreator', $this);
				break;
			case self :: ACTION_BROWSE_LOCATION_REL_TYPES :
				$component = Internship plannerManagerComponent :: factory('LocationRelTypesBrowser', $this);
				break;
			case self :: ACTION_DELETE_LOCATION_REL_TYPE :
				$component = Internship plannerManagerComponent :: factory('LocationRelTypeDeleter', $this);
				break;
			case self :: ACTION_EDIT_LOCATION_REL_TYPE :
				$component = Internship plannerManagerComponent :: factory('LocationRelTypeUpdater', $this);
				break;
			case self :: ACTION_CREATE_LOCATION_REL_TYPE :
				$component = Internship plannerManagerComponent :: factory('LocationRelTypeCreator', $this);
				break;
			case self :: ACTION_BROWSE_MENTORS :
				$component = Internship plannerManagerComponent :: factory('MentorsBrowser', $this);
				break;
			case self :: ACTION_DELETE_MENTOR :
				$component = Internship plannerManagerComponent :: factory('MentorDeleter', $this);
				break;
			case self :: ACTION_EDIT_MENTOR :
				$component = Internship plannerManagerComponent :: factory('MentorUpdater', $this);
				break;
			case self :: ACTION_CREATE_MENTOR :
				$component = Internship plannerManagerComponent :: factory('MentorCreator', $this);
				break;
			case self :: ACTION_BROWSE_MOMENTS :
				$component = Internship plannerManagerComponent :: factory('MomentsBrowser', $this);
				break;
			case self :: ACTION_DELETE_MOMENT :
				$component = Internship plannerManagerComponent :: factory('MomentDeleter', $this);
				break;
			case self :: ACTION_EDIT_MOMENT :
				$component = Internship plannerManagerComponent :: factory('MomentUpdater', $this);
				break;
			case self :: ACTION_CREATE_MOMENT :
				$component = Internship plannerManagerComponent :: factory('MomentCreator', $this);
				break;
			case self :: ACTION_BROWSE_PERIODS :
				$component = Internship plannerManagerComponent :: factory('PeriodsBrowser', $this);
				break;
			case self :: ACTION_DELETE_PERIOD :
				$component = Internship plannerManagerComponent :: factory('PeriodDeleter', $this);
				break;
			case self :: ACTION_EDIT_PERIOD :
				$component = Internship plannerManagerComponent :: factory('PeriodUpdater', $this);
				break;
			case self :: ACTION_CREATE_PERIOD :
				$component = Internship plannerManagerComponent :: factory('PeriodCreator', $this);
				break;
			case self :: ACTION_BROWSE_PLACES :
				$component = Internship plannerManagerComponent :: factory('PlacesBrowser', $this);
				break;
			case self :: ACTION_DELETE_PLACE :
				$component = Internship plannerManagerComponent :: factory('PlaceDeleter', $this);
				break;
			case self :: ACTION_EDIT_PLACE :
				$component = Internship plannerManagerComponent :: factory('PlaceUpdater', $this);
				break;
			case self :: ACTION_CREATE_PLACE :
				$component = Internship plannerManagerComponent :: factory('PlaceCreator', $this);
				break;
			case self :: ACTION_BROWSE:
				$component = Internship plannerManagerComponent :: factory('Browser', $this);
				break;
			default :
	...
	{
		return Internship plannerDataManager :: get_instance()->count_categories($condition);
	}

	function retrieve_categories($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_categories($condition, $offset, $count, $order_property);
	}

 	function retrieve_category($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_category($id);
	}

	function count_locations($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_locations($condition);
	}

	function retrieve_locations($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_locations($condition, $offset, $count, $order_property);
	}

 	function retrieve_location($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location($id);
	}

	function count_location_groups($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_location_groups($condition);
	}

	function retrieve_location_groups($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_groups($condition, $offset, $count, $order_property);
	}

 	function retrieve_location_group($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_group($id);
	}

	function count_location_rel_categories($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_location_rel_categories($condition);
	}

	function retrieve_location_rel_categories($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_categories($condition, $offset, $count, $order_property);
	}

 	function retrieve_location_rel_category($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_category($id);
	}

	function count_location_rel_mentors($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_location_rel_mentors($condition);
	}

	function retrieve_location_rel_mentors($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_mentors($condition, $offset, $count, $order_property);
	}

 	function retrieve_location_rel_mentor($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_mentor($id);
	}

	function count_location_rel_moments($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_location_rel_moments($condition);
	}

	function retrieve_location_rel_moments($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_moments($condition, $offset, $count, $order_property);
	}

 	function retrieve_location_rel_moment($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_moment($id);
	}

	function count_location_rel_types($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_location_rel_types($condition);
	}

	function retrieve_location_rel_types($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_types($condition, $offset, $count, $order_property);
	}

 	function retrieve_location_rel_type($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_location_rel_type($id);
	}

	function count_mentors($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_mentors($condition);
	}

	function retrieve_mentors($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_mentors($condition, $offset, $count, $order_property);
	}

 	function retrieve_mentor($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_mentor($id);
	}

	function count_moments($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_moments($condition);
	}

	function retrieve_moments($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_moments($condition, $offset, $count, $order_property);
	}

 	function retrieve_moment($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_moment($id);
	}

	function count_periods($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_periods($condition);
	}

	function retrieve_periods($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_periods($condition, $offset, $count, $order_property);
	}

 	function retrieve_period($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_period($id);
	}

	function count_places($condition)
	{
		return Internship plannerDataManager :: get_instance()->count_places($condition);
	}

	function retrieve_places($condition = null, $offset = null, $count = null, $order_property = null)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_places($condition, $offset, $count, $order_property);
	}

 	function retrieve_place($id)
	{
		return Internship plannerDataManager :: get_instance()->retrieve_place($id);
	}
