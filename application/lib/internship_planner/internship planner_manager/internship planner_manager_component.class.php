 ...
 * Basic functionality of a component to talk with the internship planner application
 *
 * @author Sven Vanpoucke
 * @author ehb
 */
abstract class Internship plannerManagerComponent extends WebApplicationComponent
{
	/**
	 * Constructor
	 * @param Internship planner $internship planner The internship planner which
	 * provides this component
	 */
	function Internship plannerManagerComponent($internship planner)
	{
		parent :: __construct($internship planner);
	}
