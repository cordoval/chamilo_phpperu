...
class ForumManagerForumEvaluationComponent extends ForumManager
{
    function run()
    {
        ...
        {
        	$forum_publication = $this->retrieve_forum_publication(Request :: get(ForumManager :: PARAM_FORUM_PUBLICATION));
    		...
    		$this->set_parameter(ForumManager :: PARAM_FORUM_PUBLICATION, $publication_id);
