...
class InternshipOrganizerAddLocationBrowserTableCellRenderer extends DefaultInternshipOrganizerLocationTableCellRenderer
{
    
    private $browser;

    function InternshipOrganizerAddLocationBrowserTableCellRenderer($browser)
    {
        parent :: __construct();
