...
class InternshipOrganizerAddLocationBrowserTableDataProvider extends ObjectTableDataProvider
{
     ...
     */
    function InternshipOrganizerAddLocationBrowserTableDataProvider($browser, $condition)
    {
