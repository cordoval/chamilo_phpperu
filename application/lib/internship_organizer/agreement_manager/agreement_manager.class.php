	...
	function run() {
		...
		switch ($action) {
			...
			case self::ACTION_UPDATE_AGREEMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'Updater', $this );
				break;
			case self::ACTION_DELETE_AGREEMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'Deleter', $this );
				break;
			case self::ACTION_CREATE_AGREEMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'Creator', $this );
				break;
			case self::ACTION_VIEW_AGREEMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'Viewer', $this );
				break;
			case self::ACTION_BROWSE_AGREEMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'Browser', $this );
				break;
			case self::ACTION_EDIT_MOMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'MomentUpdater', $this );
				break;
			case self::ACTION_DELETE_MOMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'MomentDeleter', $this );
				break;
			case self::ACTION_CREATE_MOMENT :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'MomentCreator', $this );
				break;
			case self::ACTION_BROWSE_MOMENTS :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'MomentBrowser', $this );
				break;
			default :
				$component = InternshipOrganizerAgreementManagerComponent::factory ( 'Browser', $this );
				break;
