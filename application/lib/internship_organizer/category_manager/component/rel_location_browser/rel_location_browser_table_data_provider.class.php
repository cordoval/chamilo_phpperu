...
class InternshipOrganizerCategoryRelLocationBrowserTableDataProvider extends ObjectTableDataProvider
{
     ...
     */
    function InternshipOrganizerCategoryRelLocationBrowserTableDataProvider($browser, $condition)
    {
    ...
    {
        return $this->get_browser()->count_full_category_rel_locations($this->get_condition());
    }
}
?>