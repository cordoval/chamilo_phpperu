...
interface InternshipOrganizerDataManagerInterface
{
    ...
    function count_internship_organizer_publications($conditions = null);

    function retrieve_internship_organizer_publication($publication_id);

    function retrieve_internship_organizer_publications($condition = null, $offset = null, $count = null, $order_property = null);
