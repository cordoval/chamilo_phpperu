...
class InternshipOrganizerAgreement extends DataClass {
	...
	static function get_default_property_names() {
		return array (self::PROPERTY_ID, self::PROPERTY_NAME, self::PROPERTY_DESCRIPTION, self::PROPERTY_BEGIN, self::PROPERTY_END, self::PROPERTY_PERIOD_ID, self::PROPERTY_LOCATION_ID, self::PROPERTY_STUDENT_ID, self::PROPERTY_STATUS );
	}
