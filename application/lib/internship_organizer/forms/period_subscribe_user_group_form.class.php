...
class InternshipOrganizerPeriodSubscribeUserGroupForm extends FormValidator
{
    ...
    function InternshipOrganizerPeriodSubscribeUserGroupForm($period, $action, $user)
    {
