...
class InternshipOrganizerAgreementForm extends FormValidator
{
    ...
    function build_basic_form()
    {
		...
		$this->addElement('text', InternshipOrganizerAgreement :: PROPERTY_DESCRIPTION, Translation :: get('Description'));
		$this->addRule(InternshipOrganizerAgreement :: PROPERTY_DESCRIPTION, Translation :: get('ThisFieldIsRequired'), 'required');
