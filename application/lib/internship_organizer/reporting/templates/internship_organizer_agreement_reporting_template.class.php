...
require_once dirname(__FILE__) . '/../blocks/internship_organizer_agreement_coordinator_reporting_block.class.php';
require_once dirname(__FILE__) . '/../blocks/internship_organizer_agreement_student_reporting_block.class.php';
require_once dirname(__FILE__) . '/../blocks/internship_organizer_agreement_coach_reporting_block.class.php';
require_once dirname(__FILE__) . '/../blocks/internship_organizer_agreement_mentor_reporting_block.class.php';
require_once dirname(__FILE__) . '/../blocks/internship_organizer_agreement_add_location_reporting_block.class.php';
require_once dirname(__FILE__) . '/../blocks/internship_organizer_agreement_to_approve_reporting_block.class.php';
