...
class InternshipOrganizerAgreementAddLocationReportingBlock extends InternshipOrganizerAgreementReportingBlock
{
    ...
    public function count_data()
    {
        ...
        $count = InternshipOrganizerDataManager :: get_instance()->count_agreements($this->get_condition(InternshipOrganizerAgreement :: STATUS_ADD_LOCATION, $coordinator_coach));
        $agreements = InternshipOrganizerDataManager :: get_instance()->retrieve_agreements($this->get_condition(InternshipOrganizerAgreement :: STATUS_ADD_LOCATION, $coordinator_coach));
