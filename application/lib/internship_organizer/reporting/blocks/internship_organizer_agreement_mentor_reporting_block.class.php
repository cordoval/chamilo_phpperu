...
class InternshipOrganizerAgreementMentorReportingBlock extends InternshipOrganizerAgreementReportingBlock
{
    ...
    public function count_data()
    {
        ...
        $mentor_count = InternshipOrganizerDataManager :: get_instance()->count_agreements($this->get_condition(InternshipOrganizerAgreement :: STATUS_APPROVED, $mentor));
        $agreements = InternshipOrganizerDataManager :: get_instance()->retrieve_agreements($this->get_condition(InternshipOrganizerAgreement :: STATUS_APPROVED, $mentor));
