...
class InternshipOrganizerOrganisationManagerComponent extends SubManagerComponent
{
    ...
    function get_create_location_url($location)
    {
        return $this->get_parent()->get_create_location_url($location);
    }
