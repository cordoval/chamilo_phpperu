...
class InternshipOrganizerRegionManagerViewerComponent extends InternshipOrganizerRegionManager
{
    ...
    function get_action_bar()
    {
        ...
        $action_bar->add_common_action(new ToolbarItem(Translation :: get('Add'), Theme :: get_common_image_path() . 'action_create.png', $this->get_region_create_url($region->get_id()), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
