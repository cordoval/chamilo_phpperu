	...
	function run() {
		...
		switch ($action) {
			...
			case self::ACTION_UPDATE_MENTOR :
				$component = InternshipOrganizerMentorManagerComponent::factory ( 'Updater', $this );
				break;
			case self::ACTION_DELETE_MENTOR :
				$component = InternshipOrganizerMentorManagerComponent::factory ( 'Deleter', $this );
				break;
			case self::ACTION_CREATE_MENTOR :
				$component = InternshipOrganizerMentorManagerComponent::factory ( 'Creator', $this );
				break;
			case self::ACTION_VIEW_MENTOR :
				$component = InternshipOrganizerMentorManagerComponent::factory ( 'Viewer', $this );
				break;
			case self::ACTION_BROWSE_MENTOR :
				$component = InternshipOrganizerMentorManagerComponent::factory ( 'Browser', $this );
				break;
			default :
				$component = InternshipOrganizerMentorManagerComponent::factory ( 'Browser', $this );
				break;
