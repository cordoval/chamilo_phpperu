...
class InternshipOrganizerPeriodManagerSubscribeGroupComponent extends InternshipOrganizerPeriodManager
{
    ...
    function run()
    {
        ...
        if (! InternshipOrganizerRights :: is_allowed_in_internship_organizers_subtree(InternshipOrganizerRights :: SUBSCRIBE_GROUP_RIGHT, $location_id, InternshipOrganizerRights :: TYPE_PERIOD))
        {
