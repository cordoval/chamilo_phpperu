    ...
    function run()
    {
        ...
        if (! empty($ids))
        {
            ...
            foreach ($ids as $id)
            {
                ...
                if (InternshipOrganizerRights :: is_allowed_in_internship_organizers_subtree(InternshipOrganizerRights :: UNSUBSCRIBE_GROUP_RIGHT, $location_id, InternshipOrganizerRights :: TYPE_PERIOD))
                {
