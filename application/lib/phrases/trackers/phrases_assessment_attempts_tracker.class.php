...
/**
 * $Id: phrases_assessment_attempts_tracker.class.php 193 2009-11-13 11:53:37Z chellee $
 * @package application.lib.assessment.trackers
 */

class PhrasesAssessmentAttemptsTracker extends MainTracker
{
     ...
     */
    function PhrasesAssessmentAttemptsTracker()
    {
        parent :: MainTracker('phrases_assessment_attempts_tracker');
    }
