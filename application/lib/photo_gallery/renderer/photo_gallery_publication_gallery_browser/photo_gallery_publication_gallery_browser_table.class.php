<?php
require_once dirname(__FILE__) . '/photo_gallery_publication_gallery_browser_table_data_provider.class.php';
require_once dirname(__FILE__) . '/photo_gallery_publication_gallery_browser_table_property_model.class.php';
require_once dirname(__FILE__) . '/photo_gallery_publication_gallery_browser_table_cell_renderer.class.php';
/**
