...
//TODO : creates ovis_ftp_accounts view in db if not possible with XML
class OvisInstaller extends Installer
{
    /**
     * Constructor
     */
    function OvisInstaller($values)
    {
        parent :: __construct($values, OvisDataManager :: get_instance());
