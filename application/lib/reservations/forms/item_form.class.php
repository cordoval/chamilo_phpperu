...
class ItemForm extends FormValidator
{
    ...
    function create_item()
    {
        ...
        if ($succes)
        {
            Event :: trigger('create_item', ReservationsManager :: APPLICATION_NAME, array(ChangesTracker :: PROPERTY_REFERENCE_ID => $item->get_id(), ChangesTracker :: PROPERTY_USER_ID => $this->user->get_id()));
        }
    ...
    function update_item()
    {
        ...
        if ($succes)
        {
            Event :: trigger('update_item', ReservationsManager :: APPLICATION_NAME, array(ChangesTracker :: PROPERTY_REFERENCE_ID => $item->get_id(), ChangesTracker :: PROPERTY_USER_ID => $this->user->get_id()));
        }
