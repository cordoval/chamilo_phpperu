...
class PortfolioManagerBrowserComponent extends PortfolioManager
{
    ...
    function get_condition()
    {
        ...
        $conditions[] = new SubselectCondition(User::PROPERTY_ID, PortfolioPublication::PROPERTY_PUBLISHER, PortfolioPublication::get_table_name(), null, PortfolioDataManager :: get_instance());
