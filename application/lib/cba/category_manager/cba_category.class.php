...
class CbaCategory extends PlatformCategory
{
    ...
    function create()
    {
        ...
        $rdm = CbaDataManager :: get_instance();
        ...
        $location->set_application(CbaManager :: APPLICATION_NAME);
        ...
        if ($parent == 0)
        {
            $parent = CbaRights :: get_user_root_id($user_id);
        }
        else
        {
            $parent = CbaRights :: get_location_id_by_identifier('cba_category', $this->get_parent());
        }
    ...
    function update()
    {
        return CbaDataManager :: get_instance()->update_category($this);
    }

    function delete()
    {
        return CbaDataManager :: get_instance()->delete_category($this);
    }
