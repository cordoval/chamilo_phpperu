 ...
 */
class CbaManagerEditorIndicatorComponent extends CbaManagerComponent
{
	/**
	...
	function run()
	{
		...
		$form = new CbaForm(CbaForm :: TYPE_EDITOR_INDICATOR, $indicator, $this->get_url(array(CbaManager :: PARAM_INDICATOR => $indicator->get_id())), $this->get_user());
