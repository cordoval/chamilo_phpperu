...
class DatabaseCdaDataManager extends Database implements CdaDataManagerInterface
{
	/*
	...
	{
		return $this->get_alias($table_name);
	}
	...
	function retrieve_translator_applications($condition = null, $offset = null, $max_objects = null, $order_by = null)
	{
		...
		$cda_language_alias = $this->get_alias(CdaLanguage :: get_table_name());
		$cda_language_table = $this->escape_table_name(CdaLanguage :: get_table_name());
