...
class CdaManagerCdaLanguagesBrowserComponent extends CdaManagerComponent
{
    ...
    function get_action_bar_html()
    {
        ...
        $action_bar->add_common_action(new ToolbarItem(Translation :: get('ApplyTranslator'), Theme :: get_image_path() . 'action_apply.png', $this->get_url(array(Application :: PARAM_ACTION => CdaManager :: ACTION_CREATE_TRANSLATOR_APPLICATION))));
