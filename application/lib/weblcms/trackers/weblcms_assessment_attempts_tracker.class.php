<?php
/**
 * $Id: weblcms_assessment_attempts_tracker.class.php 216 2009-11-13 14:08:06Z kariboe $
...
class WeblcmsAssessmentAttemptsTracker extends MainTracker
{
    ...
    {
        return array_merge(parent :: get_default_property_names(), array(self :: PROPERTY_USER_ID, self :: PROPERTY_COURSE_ID, self :: PROPERTY_ASSESSMENT_ID, self :: PROPERTY_DATE, self :: PROPERTY_TOTAL_SCORE, self :: PROPERTY_STATUS, self :: PROPERTY_START_TIME, self :: PROPERTY_TOTAL_TIME));
    }
