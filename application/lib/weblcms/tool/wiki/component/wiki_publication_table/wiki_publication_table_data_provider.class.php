<?php
/**
 * $Id: wiki_publication_table_data_provider.class.php 216 2009-11-13 14:08:06Z kariboe $
...
class WikiPublicationTableDataProvider extends ObjectTableDataProvider
{
    ...
    function get_publications($from, $count, $column, $direction)
    {
        ...
        $conditions[] = new SubselectCondition(ContentObjectPublication :: PROPERTY_CONTENT_OBJECT_ID, ContentObject :: PROPERTY_ID, ContentObject :: get_table_name(), $this->get_condition(), null, RepositoryDataManager :: get_instance());
