...
class WikiPublicationTableDataProvider extends ObjectTableDataProvider
{
    ...
    function get_publications($from, $count, $column, $direction)
    {
        ...
        $conditions[] = new SubselectCondition(ContentObjectPublication :: PROPERTY_CONTENT_OBJECT_ID, ContentObject :: PROPERTY_ID, ContentObject :: get_table_name(), $this->get_condition());
