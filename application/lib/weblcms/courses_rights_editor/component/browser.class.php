...
class CoursesRightsEditorManagerBrowserComponent extends RightsEditorManagerBrowserComponent
{
	...
	function display_location_course_group_browser()
    {
        ...
        $html[] = $tabs->render();
        $html[] = '</div>';
        $html[] = ResourceManager :: get_instance()->get_resource_html(Path :: get(WEB_PATH) . 'application/lib/weblcms/courses_rights_editor/javascript/configure_course_group.js');
