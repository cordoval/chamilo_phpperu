...
class WeblcmsManagerCourseViewerComponent extends WeblcmsManager
{
    ...
    function display_introduction_text()
    {
        ...
        if ($introduction_text)
        {
            ...
            {
                $toolbar->add_item(new ToolbarItem(Translation :: get('Edit'), Theme :: get_common_image_path() . 'action_edit.png', $this->get_url(array(Application :: PARAM_ACTION => WeblcmsManager :: ACTION_EDIT_INTRODUCTION)), ToolbarItem :: DISPLAY_ICON));
            }

            if ($this->is_allowed(DELETE_RIGHT))
            {
                $toolbar->add_item(new ToolbarItem(Translation :: get('Delete'), Theme :: get_common_image_path() . 'action_delete.png', $this->get_url(array(Application :: PARAM_ACTION => WeblcmsManager :: ACTION_DELETE_INTRODUCTION)), ToolbarItem :: DISPLAY_ICON, true));
            }
