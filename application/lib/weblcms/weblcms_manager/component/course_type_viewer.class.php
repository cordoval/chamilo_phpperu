...
class WeblcmsManagerCourseTypeViewerComponent extends WeblcmsManagerComponent
{
	...
	function get_action_bar()
	{
		...
		$action_bar->add_common_action(new ToolbarItem(Translation :: get('Delete'), Theme :: get_common_image_path().'action_delete.png', $this->get_course_type_deleting_url($course_type), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
		...
		/*
		$visible = ($courses->size() > 0);

		if($visible)
		{
			$toolbar_data[] = array(
				'href' => $this->get_course_type_emptying_url($course_type),
			...
			$action_bar->add_tool_action(new ToolbarItem(Translation :: get('Truncate'), Theme :: get_common_image_path().'action_recycle_bin.png', $this->get_course_type_emptying_url($course_type), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
		}
		else
		{
			$toolbar_data[] = array(
