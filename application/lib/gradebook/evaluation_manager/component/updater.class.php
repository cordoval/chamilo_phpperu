        ...
        //{
         //   if (! Request :: get('validated'))
          //      $success = $form->update_content_object();
            ...
            $pub_form = new EvaluationForm(EvaluationForm :: TYPE_EDIT, $publication, $this->get_url(array(EvaluationManager :: PARAM_EVALUATION_ID => $evaluation->get_id(), 'validated' => 1, EvaluationManager :: PARAM_PUBLICATION_ID => $publication->get_id())), $this->get_user());
