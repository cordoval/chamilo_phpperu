...
// gradebook evaluation
	...
	function retrieve_all_evaluations_on_publication($publication_id, $offset = null, $max_objects = null, $order_by = null)
	{
		...
		$query = 'SELECT ' . $gradebook_evaluation_alias . '.' . $this->database->escape_column_name(Evaluation :: PROPERTY_ID) . ', ' . $gradebook_evaluation_alias . '.' . $this->database->escape_column_name(Evaluation :: PROPERTY_EVALUATION_DATE); 
