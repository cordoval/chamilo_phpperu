...
class TestSurveyPublicationBrowserTableCellRenderer extends DefaultSurveyPublicationTableCellRenderer
{
    /**
     ...
     */
    function TestSurveyPublicationBrowserTableCellRenderer($browser)
    {
        parent :: __construct();
    ...
    {
        if ($column === TestSurveyPublicationBrowserTableColumnModel :: get_modification_column())
        {
    ...
    private function get_modification_links($survey_publication)
    {
        ...
        $toolbar_data[] = array('href' => $this->browser->get_browse_test_survey_participants_url($survey_publication), 'label' => Translation :: get('TakeSurvey'), 'img' => Theme :: get_common_image_path() . 'action_next.png');
