...
class TestCaseManagerUserBrowserTableDataProvider extends ObjectTableDataProvider
{
	
	private $browser;

	function TestCaseManagerUserBrowserTableDataProvider($browser, $condition)
	{
