...
class TestcaseSurveyParticipantBrowserTableColumnModel extends DefaultParticipantTableColumnModel
{
    /**
     ...
     * Constructor
     */
    function TestcaseSurveyParticipantBrowserTableColumnModel()
    {
        parent :: __construct();
