...
class SurveyParticipantReportingFilterBlock extends SurveyReportingBlock
{
    ...
    public function count_data()
    {
        ...
        $condition = new InCondition(SurveyParticipantTracker :: PROPERTY_SURVEY_PUBLICATION_ID, $publication_ids);
