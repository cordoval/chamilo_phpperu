...
class PersonalMessengerManagerPublisherComponent extends PersonalMessengerManager implements RepoViewerInterface
{
    ...
    function run()
    {
        if (!PersonalMessengerRights :: is_allowed_in_personal_messenger_subtree(PersonalMessengerRights :: RIGHT_SEND, PersonalMessengerRights :: get_personal_messenger_subtree_root()))
        {
            $this->display_header();
