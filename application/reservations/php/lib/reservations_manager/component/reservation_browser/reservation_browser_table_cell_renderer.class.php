...
require_once WebApplication :: get_application_class_lib_path('reservations') . 'tables/reservation_table/default_reservation_table_cell_renderer.class.php';
...
class ReservationBrowserTableCellRenderer extends DefaultReservationTableCellRenderer
{
    ...
    private function get_modification_links($reservation)
    {
        ...
        if ($this->browser instanceof ReservationsManagerAdminReservationBrowserComponent && ($this->browser->is_allowed_to_edit() || $this->browser->has_right(ReservationsRights :: TYPE_ITEM, $reservation->get_item(), ReservationsRights :: EDIT_RIGHT)))
        {
