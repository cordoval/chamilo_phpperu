    ...
    function run()
    {
        ...
        if ($ids)
        {
            ...
            foreach ($ids as $id)
            {
                ...
                {
                    Event :: trigger('delete_reservation', ReservationsManager :: APPLICATION_NAME, array(
            ...
            $this->redirect($message, ! $bool, array(
                    ReservationsManager :: PARAM_ACTION => ReservationsManager :: ACTION_ADMIN_BROWSE_RESERVATIONS,
