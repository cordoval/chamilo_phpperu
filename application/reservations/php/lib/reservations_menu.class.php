...
class ReservationsMenu extends HTML_Menu
{
     ...
     * "?category=%s".
     */
    function __construct($current_item, $url_format = '?application=reservations&go=browse_categories&category_id=%s')
    {
    ...
    private function get_menu_items($parent_id)
    {
        ...
        $datamanager = $this->dm;
        $objects = $datamanager->retrieve_categories($condition, null, null, array(
                new ObjectTableOrder(Category :: PROPERTY_DISPLAY_ORDER)));
