 ...
 */
class GoogleDocsExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === GoogleDocsExternalRepositoryTableColumnModel :: get_modification_column())
        {
        ...
        switch ($column->get_name())
        {
            ...
            case GoogleDocsExternalRepositoryObject :: PROPERTY_ACL :
                return $external_object->get_acl();
        }
