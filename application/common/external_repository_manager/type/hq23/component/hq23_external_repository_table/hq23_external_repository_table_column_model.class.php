 ...
 */
class Hq23ExternalRepositoryTableColumnModel extends DefaultExternalRepositoryObjectTableColumnModel
{
    /**
    ...
    function Hq23ExternalRepositoryTableColumnModel()
    {
        ...
        $this->add_column(new ObjectTableColumn(Hq23ExternalRepositoryObject :: PROPERTY_LICENSE));
