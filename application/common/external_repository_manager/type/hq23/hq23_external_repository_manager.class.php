 ...
 * @author Magali
 */
class Hq23ExternalRepositoryManager extends ExternalRepositoryManager
{
    ...
    {
        return Path :: get_application_library_path() . 'external_repository_manager/type/hq23/component/';
    }
