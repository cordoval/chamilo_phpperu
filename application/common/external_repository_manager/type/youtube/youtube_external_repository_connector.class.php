...
class YoutubeExternalRepositoryMediaConnector
{
    ...
    function YoutubeExternalRepositoryMediaConnector($manager)
    {
    ...
    static function get_instance($manager)
    {
        ...
        {
            self :: $instance = new YoutubeExternalRepositoryMediaConnector($manager);
        }
