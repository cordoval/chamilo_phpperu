...
require_once dirname(__FILE__) . '/table/youtube_external_repository_browser_table_property_model.class.php';
...
class YoutubeExternalRepositoryManager extends ExternalRepositoryManager
{
    ...
    {
        return new YoutubeExternalRepositoryBrowserPropertyModel();
    }
