 ...
 */
class DropIoExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
     ...
     */
    function DropIoExternalRepositoryTableCellRenderer($browser)
    {
        parent :: __construct();
    ...
    {
        if ($column === DropIoExternalRepositoryTableColumnModel :: get_modification_column())
        {
