...
class FlickrExternalRepositoryManagerForm extends FormValidator
{
    ...
    {
        return FlickrExternalRepositoryConnector :: get_instance($this->application)->update_external_repository_object($this->exportValues());
    }
    ...
    function upload_photo()
    {
        ...
        {
            return FlickrExternalRepositoryConnector :: get_instance($this->application)->create_external_repository_object($this->exportValues(), $_FILES[self :: FILE]['tmp_name']);
        }
        else
        {
            return false;
