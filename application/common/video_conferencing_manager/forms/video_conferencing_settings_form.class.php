...
class VideoConferencingSettingsForm extends FormValidator
{
    ...
    private function build_form()
    {
        ...
        if (count($configuration['settings']) > 0)
        {
            ...
            require_once Path :: get_application_library_path() . 'video_conferencing_manager/type/' . $video_conferencing->get_type() . '/settings/settings_' . $video_conferencing->get_type() . '_connector.class.php';
    ...
    function parse_settings()
    {
        ...
        $file = Path :: get_application_library_path() . 'video_conferencing_manager/type/' . $video_conferencing->get_type() . '/settings/settings_' . $video_conferencing->get_type() . '.xml';
        $result = array();
