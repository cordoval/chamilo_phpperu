...
require_once dirname(__FILE__) . '/../mediamosa_streaming_media_data_manager.interface.class.php';

class DatabaseMediamosaStreamingMediaDataManager extends Database implements MediamosaStreamingMediaDataManagerInterface
{
    function initialize()
    {
     parent :: initialize();
