	...
	function run()
	{
		...
		if ($form->validate())
        {
            ...
            if ($upload_token)
            {
                ...
                {
                	$platform_url = Redirect :: web_link(PATH :: get(WEB_PATH) . 'common/launcher/index.php', $parameters);
                }
                else
                {
                	$platform_url = Redirect :: web_link(PATH :: get(WEB_PATH) . 'core.php', $parameters);
                }
