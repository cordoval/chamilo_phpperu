...
class VariableTranslationForm extends FormValidator
{
    ...
    function build_basic_form()
    {
		...
		{
			$source = PackageDataManager :: get_instance()->retrieve_variable_translation_by_parameters($source_id, $this->variable->get_id());
	...
	function add_other_translations($english_id)
	{
		...
		while($translation = $translations->next_result())
		{
			...
			$language = $dm->retrieve_package_language($translation->get_language_id());
