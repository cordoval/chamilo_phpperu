...
class VariableTranslationSearchForm extends FormValidator
{
    ...
    {
    	$package_languages = $this->manager->retrieve_package_languages(null, null, null, new ObjectTableOrder(PackageLanguage :: PROPERTY_ENGLISH_NAME));
    	
    	$languages = array();
    	
    	while($language = $package_languages->next_result())
    	{
