...
class DefaultTranslatorApplicationTableColumnModel extends ObjectTableColumnModel
{
	...
	private static function get_default_columns()
	{
		...
		$column = new ObjectTableColumn(PackageLanguage :: PROPERTY_ENGLISH_NAME, true, $alias);
		$column->set_title(Translation :: get('SourceLanguage'));
		$columns[] = $column;

		$column = new ObjectTableColumn(PackageLanguage :: PROPERTY_ENGLISH_NAME, true, $alias . '2');
