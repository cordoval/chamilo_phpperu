 ...
 */
class PackageManagerHistoricVariableTranslationDeleterComponent extends PackageManager
{
	/**
	...
	function run()
	{
		...
		if (!empty ($ids))
		{
			...
			$this->redirect($message, !$failures, array(PackageManager :: PARAM_ACTION => PackageManager :: ACTION_VIEW_VARIABLE_TRANSLATION, PackageManager :: PARAM_VARIABLE_TRANSLATION => $historic_variable_translation->get_variable_translation_id()));
		}
		else
		{
	...
	function add_additional_breadcrumbs(BreacrumbTrail $breadcrumbtrail)
    {
    	...
    	$breadcrumbtrail->add_help('package_variable_translations_historic_deleter');
    }
