...
require_once WebApplication :: get_application_class_lib_path('package') . 'package_manager/component/translation_exporter/translation_exporter.class.php';
...
class ExporterWizardProcess extends HTML_QuickForm_Action
{
    ...
    function perform($page, $actionName)
    {
    	...
    	$languages = $this->parent->retrieve_package_languages(new InCondition(PackageLanguage :: PROPERTY_ID, $language_ids))->as_array();
    	...
    	$condition = new InCondition(PackageLanguage :: PROPERTY_ID, array_keys($values['language']));
    	...
    	$language_packs = PackageDataManager :: get_instance()->retrieve_language_packs($condition, null, null, array(new ObjectTableOrder(LanguagePack :: PROPERTY_NAME)));
