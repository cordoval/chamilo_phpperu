...
class LanguageSelectingExporterWizardPage extends ExporterWizardPage
{
    ...
    function buildForm()
    {
    	...
    	$this->addElement('html', ResourceManager :: get_instance()->get_resource_html(Path :: get(WEB_PATH) . 'common/javascript/package_export.js'));
    	...
    	$languages = $this->get_parent()->get_parent()->retrieve_package_languages(null, null, null, new ObjectTableOrder(PackageLanguage :: PROPERTY_ENGLISH_NAME));
