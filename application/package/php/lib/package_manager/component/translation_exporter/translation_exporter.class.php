...
abstract class TranslationExporter
{
    ...
    function get_translations($language, $language_pack)
    {
    	...
    	return PackageDataManager :: get_instance()->retrieve_variable_translations($condition);
    }
    
    function retrieve_variable_from_translation($translation)
    {
    	return PackageDataManager :: get_instance()->retrieve_variable($translation->get_variable_id());
    }
