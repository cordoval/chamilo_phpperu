...
require_once WebApplication :: get_application_class_lib_path('package') . 'tables/historic_variable_translation_table/default_historic_variable_translation_table_column_model.class.php';
