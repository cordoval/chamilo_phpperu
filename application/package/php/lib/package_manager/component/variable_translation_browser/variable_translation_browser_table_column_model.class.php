...
require_once WebApplication :: get_application_class_lib_path('package') . 'tables/variable_translation_table/default_variable_translation_table_column_model.class.php';
