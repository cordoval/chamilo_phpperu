...
require_once dirname(__FILE__).'/../../package_manager.class.php';
...
class VariableTranslationBrowserTableCellRenderer extends DefaultVariableTranslationTableCellRenderer
{
	...
	private function get_modification_links($variable_translation)
	{
		...
		$can_translate = PackageRights :: is_allowed_in_languages_subtree(PackageRights :: VIEW_RIGHT, $variable_translation->get_language_id(), 'package_language');
		$can_lock = PackageRights :: is_allowed_in_languages_subtree(PackageRights :: EDIT_RIGHT, $variable_translation->get_language_id(), 'package_language');
