 ...
 */
class PackageManagerPackageBrowserComponent extends PackageManager
{
    private $action_bar;
    ...
    function get_table()
    {
        $table = new PackageBrowserTable($this, array(Application :: PARAM_APPLICATION => 'package', Application :: PARAM_ACTION => PackageManager :: ACTION_BROWSE_PACKAGE), $this->get_condition());
    ...
    function get_action_bar()
    {
        ...
        $action_bar->add_tool_action(new ToolbarItem(Translation :: get('Create'), Theme :: get_common_image_path() . 'action_create.png', $this->get_url(array(Application :: PARAM_ACTION => PackageManager :: ACTION_CREATE_PACKAGE))));
        $action_bar->add_tool_action(new ToolbarItem(Translation :: get('UpdateList'), Theme :: get_image_path() . 'action_update.png', $this->get_url(array(Application :: PARAM_ACTION => PackageManager :: ACTION_SYNCHRONIZE_PACKAGE))));
...
//             $action_bar->add_common_action(new ToolbarItem(Translation :: get('ShowAll', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_browser.png', $this->get_url()));
    ...
    {
        //    	$properties[] = new ConditionProperty(PackageLanguage :: PROPERTY_ENGLISH_NAME);
        //    	$properties[] = new ConditionProperty(PackageLanguage :: PROPERTY_ORIGINAL_NAME);
