 ...
 */
require_once WebApplication :: get_application_class_lib_path('laika') . 'laika_manager/component/laika_user_browser_table_data_provider.class.php';
...
require_once WebApplication :: get_application_class_lib_path('laika') . 'laika_manager/component/laika_user_browser_table_cell_renderer.class.php';
