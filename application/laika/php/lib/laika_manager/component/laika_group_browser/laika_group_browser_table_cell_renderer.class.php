...
require_once CoreApplication :: get_application_class_lib_path('group') . 'group_table/default_group_table_cell_renderer.class.php';
/**
...
class LaikaGroupBrowserTableCellRenderer extends DefaultGroupTableCellRenderer
{
    ...
    function render_cell($column, $group)
    {
        ...
        switch ($column->get_name())
        {
            ...
            case Translation :: get('Users', null, Utilities::USER) :
                return $group->count_users(true, true);
            case Translation :: get('Subgroups', null, Utilities::GROUP) :
