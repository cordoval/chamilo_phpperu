...
require_once Path :: get_application_path() . 'lib/internship_organizer/import/internship_organizer_import.class.php';
...
class InternshipOrganizerCategoryImportForm extends FormValidator
{
     ...
     */
    function InternshipOrganizerCategoryImportForm($form_name, $method = 'post', $action = null, $category_id, $user, $import_type = null)
    {
    ...
    function get_types()
    {
        $folder = Path :: get_application_path() . 'lib/internship_organizer/import/';
