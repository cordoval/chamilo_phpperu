...
require_once Path :: get_application_path() . '/internship_organizer/php/mentor.class.php';
require_once Path :: get_application_path() . '/internship_organizer/php/mentor_rel_location.class.php';
