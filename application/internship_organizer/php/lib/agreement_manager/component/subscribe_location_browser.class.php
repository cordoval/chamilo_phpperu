...
require_once Path :: get_application_path() . 'internship_organizer/php/agreement_manager/component/subscribe_location_browser/subscribe_location_browser_table.class.php';
...
class InternshipOrganizerAgreementManagerSubscribeLocationBrowserComponent extends InternshipOrganizerAgreementManager
{
    ...
    function add_additional_breadcrumbs(BreadcrumbTrail $breadcrumbtrail)
    {
        ...
        $breadcrumbtrail->add(new Breadcrumb($this->get_url(array(self :: PARAM_ACTION => self :: ACTION_VIEW_AGREEMENT, self :: PARAM_AGREEMENT_ID => $agreement_id, DynamicTabsRenderer :: PARAM_SELECTED_TAB => InternshipOrganizerAgreementManagerViewerComponent :: TAB_LOCATIONS)), Translation :: get('ViewInternshipOrganizerAgreement')));
    }
