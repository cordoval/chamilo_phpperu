...
require_once WebApplication :: get_application_class_lib_path('internship_organizer') . 'organisation_manager/component/mentor_rel_location_browser/browser_table.class.php';
require_once WebApplication :: get_application_class_lib_path('internship_organizer') . 'organisation_manager/component/mentor_rel_user_browser/rel_user_browser_table.class.php';
...
class InternshipOrganizerOrganisationManagerMentorViewerComponent extends InternshipOrganizerOrganisationManager
{
    ...
    function add_additional_breadcrumbs(BreadcrumbTrail $breadcrumbtrail)
    {
        ...
        $breadcrumbtrail->add(new Breadcrumb($this->get_url(array(
                ...
                DynamicTabsRenderer :: PARAM_SELECTED_TAB => InternshipOrganizerOrganisationManagerViewerComponent :: TAB_MENTORS)), Translation :: get('ViewInternshipOrganizerOrganisation')));
