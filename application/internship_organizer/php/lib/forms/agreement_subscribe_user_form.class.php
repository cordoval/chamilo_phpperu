...
class InternshipOrganizerAgreementSubscribeUserForm extends FormValidator
{
    ...
    function build_form()
    {
        ...
        $url = Path :: get(WEB_PATH) . 'application/internship_organizer/php/xml_feeds/xml_period_rel_user_feed.php?period_id=' . $this->agreement->get_period_id() . '&user_type=' . $this->user_type;
