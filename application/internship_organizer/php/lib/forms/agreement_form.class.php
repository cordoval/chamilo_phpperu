...
class InternshipOrganizerAgreementForm extends FormValidator
{
    ...
    function __construct($form_type, $agreement, $action, $user_ids)
    {
    ...
    function build_creation_form()
    {
        ...
        $url = Path :: get(WEB_PATH) . 'application/internship_organizer/php/xml_feeds/xml_period_feed.php';
            ...
            foreach ($rights as $right_name => $right)
            {
                ...
                if ($i = InternshipOrganizerUserType :: COACH)
                {
                    if (in_array($right, array(
                            InternshipOrganizerRights :: RIGHT_VIEW, InternshipOrganizerRights :: ADD_LOCATION_RIGHT, InternshipOrganizerRights :: APPROVE_LOCATION_RIGHT, 
                            InternshipOrganizerRights :: ADD_MENTOR_RIGHT, InternshipOrganizerRights :: ADD_MOMENT_RIGHT, InternshipOrganizerRights :: RIGHT_PUBLISH)))
                    {
                        $default_settings[$i][$right] = 1;
                    }
                ...
                {
                    if (in_array($right, array(
                            InternshipOrganizerRights :: RIGHT_VIEW, InternshipOrganizerRights :: ADD_LOCATION_RIGHT, InternshipOrganizerRights :: ADD_MOMENT_RIGHT, 
                            InternshipOrganizerRights :: RIGHT_PUBLISH)))
                    {
                        $default_settings[$i][$right] = 1;
                    }
                }
