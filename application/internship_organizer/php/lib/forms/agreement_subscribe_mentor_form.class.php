...
class InternshipOrganizerAgreementSubscribeMentorForm extends FormValidator
{
    ...
    function __construct($agreement, $action, $user)
    {
    ...
    function build_form()
    {
        ...
        $url = Path :: get(WEB_PATH) . 'application/internship_organizer/php/xml_feeds/xml_mentor_feed.php?location_id=' . $location_id;
