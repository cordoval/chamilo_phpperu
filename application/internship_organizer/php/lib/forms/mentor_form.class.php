...
class InternshipOrganizerMentorForm extends FormValidator
{
    ...
    function build_basic_form()
    {
        ...
        $url = Path :: get(WEB_PATH) . 'application/internship_organizer/php/xml_feeds/xml_location_feed.php?organisation_id=' . $this->mentor->get_organisation_id();
        ...
        $url = Path :: get(WEB_PATH) . 'application/internship_organizer/php/xml_feeds/xml_organisation_user_feed.php?organisation_id=' . $this->mentor->get_organisation_id();
        $locale = array();
        $locale['Display'] = Translation :: get('ChooseUsers');
        $locale['Searching'] = Translation :: get('Searching');
        $locale['NoResults'] = Translation :: get('NoResults');
