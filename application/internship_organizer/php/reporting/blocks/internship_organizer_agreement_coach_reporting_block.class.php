...
class InternshipOrganizerAgreementCoachReportingBlock extends InternshipOrganizerAgreementReportingBlock
{
    ...
    public function count_data()
    {
        ...
        $coach_count = InternshipOrganizerDataManager :: get_instance()->count_agreements($this->get_condition(InternshipOrganizerAgreement :: STATUS_APPROVED, $coach));
        $agreements = InternshipOrganizerDataManager :: get_instance()->retrieve_agreements($this->get_condition(InternshipOrganizerAgreement :: STATUS_APPROVED, $coach));
