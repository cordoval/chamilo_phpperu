...
require_once Path :: get_application_path() . 'internship_organizer/php/forms/appointment_form.class.php';
require_once Path :: get_application_path() . 'internship_organizer/php/appointment_manager/component/browser.class.php';
