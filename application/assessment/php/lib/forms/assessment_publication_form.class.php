...
class AssessmentPublicationForm extends FormValidator
{
    ...
    function add_footer()
    {
        ...
        $buttons[] = $this->createElement('style_submit_button', 'publish_and_build', Translation :: get('PublishAndBuild', null, Utilities :: COMMON_LIBRARIES), array('class' => 'positive build'));
