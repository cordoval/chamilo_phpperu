...
CKEDITOR.editorConfig = function( config )
{
	...
	config.toolbar_Basic =
		[
		 	['Maximize','-','Styles','Format','Font','FontSize','-','Bold','Italic','Underline','-','NumberedList', 'BulletedList','HorizontalRule','-','Link','Unlink','-','TextColor','BGColor','-','Table','Image','Chamiloflash'/*,'Chamiloflashvideo'*/,'Chamiloyoutube','Chamilovideo','Chamiloaudio','latex','-','Templates','SpecialChar','-','Source']
		];
