...
class PhotoGalleryPublisher
{
    ...
    function get_publications_form($ids)
    {
        ...
        $form = new PhotoGalleryPublicationForm(PhotoGalleryPublicationForm :: TYPE_MULTI, $ids, $this->parent->get_user(), $this->parent->get_url($parameters));
        if ($form->validate())
        {
