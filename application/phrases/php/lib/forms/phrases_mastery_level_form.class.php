...
class PhrasesMasteryLevelForm extends FormValidator
{
    ...
    function build_basic_form()
    {
        ...
        $this->addRule(PhrasesMasteryLevel :: PROPERTY_LEVEL, Translation :: get('ThisFieldIsRequired', null, Utilities::COMMON_LIBRARIES), 'required');
        $this->addRule(PhrasesMasteryLevel :: PROPERTY_UPGRADE_AMOUNT, Translation :: get('ThisFieldIsRequired', null, Utilities::COMMON_LIBRARIES), 'required');
        $this->addRule(PhrasesMasteryLevel :: PROPERTY_UPGRADE_SCORE, Translation :: get('ThisFieldIsRequired', null, Utilities::COMMON_LIBRARIES), 'required');
    }
