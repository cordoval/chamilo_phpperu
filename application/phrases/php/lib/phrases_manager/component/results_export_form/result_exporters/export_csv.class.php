...
class ResultsCsvExport extends ResultsExport
{
    ...
    function export_publication_id($id)
    {
        ...
        $condition = new EqualityCondition(PhrasesPhrasesAttemptsTracker :: PROPERTY_PHRASES_ID, $publication->get_id());
    ...
    function export_header($phrases)
    {
        ...
        $this->data[] = $this->currentrow;
        $this->currentrow = array(self :: PROPERTY_USERNAME, self :: PROPERTY_RESULT,
