...
class PhrasesAssessmentAttemptsTracker extends SimpleTracker
{
    ...
    {
        return parent :: get_default_property_names(array(self :: PROPERTY_USER_ID, self :: PROPERTY_PUBLICATION_ID, self :: PROPERTY_DATE, self :: PROPERTY_TOTAL_SCORE, self :: PROPERTY_STATUS, self :: PROPERTY_START_TIME, self :: PROPERTY_TOTAL_TIME));
    }
    ...
    function get_pubication_id()
    {
        return $this->get_default_property(self :: PROPERTY_PUBLICATION_ID);
    }

    function set_pubication_id($pubication_id)
    {
        $this->set_default_property(self :: PROPERTY_PUBLICATION_ID, $pubication_id);
    }
