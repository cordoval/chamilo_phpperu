 ...
 */
require_once WebApplication :: get_application_class_lib_path('cda') . 'cda_manager/component/historic_variable_translation_browser/historic_variable_translation_browser_table_data_provider.class.php';
require_once WebApplication :: get_application_class_lib_path('cda') . 'cda_manager/component/historic_variable_translation_browser/historic_variable_translation_browser_table_column_model.class.php';
require_once WebApplication :: get_application_class_lib_path('cda') . 'cda_manager/component/historic_variable_translation_browser/historic_variable_translation_browser_table_cell_renderer.class.php';
