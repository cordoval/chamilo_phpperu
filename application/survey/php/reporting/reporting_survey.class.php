...
class ReportingSurvey
{
    ...
    public static function getSummarySurveyParticipation($params)
    {
        ...
        while ($publication = $publications->next_result())
        {
            ...
            foreach ($trackers as $tracker)
            {
                ...
                $toolbar->add_item(new ToolbarItem(Translation :: get('ViewResults'), Theme :: get_common_image_path() . 'action_view_results.png', $url . '&' . SurveyManager :: PARAM_PUBLICATION_ID . '=' . $publication->get_id(), ToolbarItem :: DISPLAY_ICON));
    ...
    public static function getSurveyQuestionAnswers($params)
    {
        ...
        foreach ($trackers as $tracker)
        {
            ...
            $toolbar->add_item(new ToolbarItem(Translation :: get('ViewResults'), Theme :: get_common_image_path() . 'action_view_results.png', $url . '&' . SurveyManager :: PARAM_SURVEY_QUESTION_ID . '=' . $question_id, ToolbarItem :: DISPLAY_ICON));
