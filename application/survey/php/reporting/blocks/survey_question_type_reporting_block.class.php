...
class SurveyQuestionTypeReportingBlock extends SurveyReportingBlock
{
    ...
    public function count_data()
    {
        ...
        $reporting_data->set_categories(array(Translation :: get(SurveyRatingQuestion :: get_type_name()), Translation :: get(SurveyOpenQuestion :: get_type_name()), //	Translation::get ( SurveyMultipleChoiceQuestion :: get_type_name()),
        Translation :: get(SurveyMultipleChoiceQuestion :: get_type_name()) . self :: ANSWER_TYPE_CHECKBOX, Translation :: get(SurveyMultipleChoiceQuestion :: get_type_name()) . self :: ANSWER_TYPE_RADIO, Translation :: get(SurveyMatchingQuestion :: get_type_name()), Translation :: get(SurveySelectQuestion :: get_type_name()) . self :: SINGLE_SELECT_TYPE, Translation :: get(SurveySelectQuestion :: get_type_name()) . self :: MULTIPLE_SELECT_TYPE, //Translation::get ( SurveyMatrixQuestion :: get_type_name()),
        Translation :: get(SurveyMatrixQuestion :: get_type_name()) . self :: MATRIX_TYPE_RADIO, Translation :: get(SurveyMatrixQuestion :: get_type_name()) . self :: MATRIX_TYPE_CHECKBOX));
