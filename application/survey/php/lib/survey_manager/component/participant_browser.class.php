...
class SurveyManagerParticipantBrowserComponent extends SurveyManager
{
    ...
    function run()
    {
        ...
        $this->survey_publication = SurveyDataManager :: get_instance()->retrieve_survey_publication($this->pid);
    ...
    function get_no_participant_condition()
    {
        ...
        $context_template = $this->survey->get_context_template_for_level();
        ...
        if ($context_template)
        {
            ...
            $invited_users = SurveyRights :: get_allowed_users(SurveyRights :: RIGHT_PARTICIPATE, $this->pid, SurveyRights :: TYPE_PUBLICATION);
