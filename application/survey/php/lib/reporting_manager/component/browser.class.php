...
class SurveyReportingManagerBrowserComponent extends SurveyReportingManager
{
    ...
    function get_tabs_html()
    {
        ...
        $tabs->add_tab(new DynamicContentTab(self :: TAB_PUBLICATION_REL_TEMPLATE_REGISTRATIONS, Translation :: get('ReportingTemplates'), Theme :: get_image_path('survey') . 'survey-16.png', $table->as_html()));
        ...
        if (SurveyRights :: is_allowed_in_surveys_subtree(SurveyRights :: RIGHT_ADD_REPORTING_TEMPLATE, $this->publication_id, SurveyRights :: TYPE_PUBLICATION))
        {
            ...
            $tabs->add_tab(new DynamicContentTab(self :: TAB_TEMPLATE_REGISTRATIONS, Translation :: get('AddReportingTemplates'), Theme :: get_image_path('survey') . 'survey-16.png', $table->as_html()));
        }
