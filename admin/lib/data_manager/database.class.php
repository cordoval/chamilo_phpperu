...
class DatabaseAdminDataManager extends AdminDataManager
{
    ...
    {
        $query = 'SELECT * FROM ' . $this->database->escape_table_name('system_announcement_publication_group') . ' WHERE system_announcement_publication_id = ' . $this->quote($system_announcement_publication->get_id());
        $res = $this->query($query);
        $groups = array();
    ...
    {
        $query = 'SELECT * FROM ' . $this->database->escape_table_name('system_announcement_publication_user') . ' WHERE system_announcement_publication_id = ' . $this->quote($system_announcement_publication->get_id());
        $res = $this->query($query);
        $users = array();
