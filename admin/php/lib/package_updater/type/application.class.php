...
require_once Path :: get_common_libraries_class_path() . 'updater.class.php';
...
class PackageUpdaterApplicationType extends PackageUpdaterType
{
    ...
    function update()
    {
        ...
        {
            if (version_compare($folder, $this->get_parent()->get_registration()->get_version(), '>') && version_compare(PackageInfo :: factory(Registration :: TYPE_APPLICATION, $application_name)->get_package()->get_version(), $folder, '>='))
            {
