...
class PackageUpdaterContentObjectType extends PackageUpdaterType
{
    ...
    function update()
    {
        ...
        {
            if (version_compare($folder, $this->get_parent()->get_registration()->get_version(), '>') && version_compare(PackageInfo :: factory(Registration :: TYPE_CONTENT_OBJECT, $type)->get_package()->get_version(), $folder, '>='))
            {
