...
/**
 * $Id: extension_registration_browser_table_cell_renderer.class.php 168 2009-11-12 11:53:23Z vanpouckesven $
 ...
 */
class ExtensionRegistrationBrowserTableCellRenderer extends DefaultRegistrationTableCellRenderer
{
    /**
    ...
    {
        if ($column === ExtensionRegistrationBrowserTableColumnModel :: get_modification_column())
        {
