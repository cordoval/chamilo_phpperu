...
/**
 * $Id: language_registration_browser_table_cell_renderer.class.php 168 2009-11-12 11:53:23Z vanpouckesven $
 ...
 */
class LanguageRegistrationBrowserTableCellRenderer extends DefaultRegistrationTableCellRenderer
{
    /**
    ...
    {
        if ($column === LanguageRegistrationBrowserTableColumnModel :: get_modification_column())
        {
