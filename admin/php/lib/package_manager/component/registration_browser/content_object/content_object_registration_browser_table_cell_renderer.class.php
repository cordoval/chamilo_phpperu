...
/**
 * $Id: content_object_registration_browser_table_cell_renderer.class.php 168 2009-11-12 11:53:23Z vanpouckesven $
 ...
 */
class ContentObjectRegistrationBrowserTableCellRenderer extends DefaultRegistrationTableCellRenderer
{
    /**
    ...
    {
        if ($column === ContentObjectRegistrationBrowserTableColumnModel :: get_modification_column())
        {
    ...
    private function get_modification_links($registration)
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('Deinstall', array(), Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_deinstall.png', $this->browser->get_registration_removal_url($registration), ToolbarItem :: DISPLAY_ICON, true));
