...
/**
 * $Id: library_registration_browser_table_cell_renderer.class.php 168 2009-11-12 11:53:23Z vanpouckesven $
 ...
 */
class LibraryRegistrationBrowserTableCellRenderer extends DefaultRegistrationTableCellRenderer
{
    /**
    ...
    {
        if ($column === LibraryRegistrationBrowserTableColumnModel :: get_modification_column())
        {
