...
/**
 * $Id: video_conferencing_manager_registration_browser_table_cell_renderer.class.php 168 2009-11-12 11:53:23Z vanpouckesven $
 ...
 */
class VideoConferencingManagerRegistrationBrowserTableCellRenderer extends DefaultRegistrationTableCellRenderer
{
    /**
    ...
    {
        if ($column === VideoConferencingManagerRegistrationBrowserTableColumnModel :: get_modification_column())
        {
