...
class VideoConferencingManagerPackageInfo extends PackageInfo
{

    function get_path()
    {
        return Path :: get_common_extensions_path() . 'video_conferencing_manager/implementation/' . $this->get_package_name() . '/' . Path :: CLASS_PATH . '/';
    }
}
?>