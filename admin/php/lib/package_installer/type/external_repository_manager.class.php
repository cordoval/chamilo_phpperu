...
class PackageInstallerExternalRepositoryManagerType extends PackageInstallerType
{
    ...
    function install()
    {
        ...
        {
            $this->get_parent()->installation_successful('dependencies', Translation :: get('ExternalRepositoryManagerDependenciesVerified'));
    ...
    static function get_path($external_repository_manager_name)
    {
        return Path :: get_common_extensions_path() . 'external_repository_manager/implementation/' . $external_repository_manager_name . '/' . Path :: CLASS_PATH . '/';
    }
