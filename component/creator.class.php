...
class SurveyBuilderCreatorComponent extends SurveyBuilderComponent
{
    ...
    function run()
    {
        ...
        {
            $survey_page_ids = Request :: get(SurveyBuilder :: PARAM_SURVEY_PAGE_ID);
            if (! is_array($survey_page_ids))
                $survey_page_ids = array($survey_page_ids);
        }
