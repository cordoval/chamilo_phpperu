 ...
 */
class ImageContentObjectTableCellRenderer extends DefaultContentObjectTableCellRenderer
{
     ...
     */
    function ImageContentObjectTableCellRenderer($table_actions)
    {
    ...
    {
        if ($column === ImageContentObjectTableColumnModel :: get_action_column())
        {
