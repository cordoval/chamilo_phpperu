...
abstract class NestedTreeNode extends DataClass
{
    ...
    {
        return $this->get_data_manager()->nested_tree_count_children($this, $recursive, $condition);
    }
    ...
    {
        return $this->get_data_manager()->nested_tree_get_children($this, $recursive, $condition);
    }
    ...
    {
        return $this->get_data_manager()->nested_tree_count_parents($this, $include_self, $condition);
    }
    ...
    {
        return $this->get_data_manager()->nested_tree_get_parents($this, true, $include_self, $condition);
    }
    ...
    function get_parent()
    {
        return $this->get_data_manager()->nested_tree_retrieve_parent_from_node($this);
    }
    ...
    function is_child_of($node)
    {
        if (! is_object($node))
        {
            $node = $this->get_data_manager()->nested_tree_retrieve_node($this, $node);
        }
    ...
    {
        return $this->get_data_manager()->nested_tree_count_sibblings($this, $include_self, $condition);
    }
    ...
    {
        return $this->get_data_manager()->nested_tree_get_sibblings($this, $include_self, $condition);
    }
