 ...
 */
require_once dirname(__FILE__) . '/flash_video_content_object_table_data_provider.class.php';
require_once dirname(__FILE__) . '/flash_video_content_object_table_column_model.class.php';
require_once dirname(__FILE__) . '/flash_video_content_object_table_cell_renderer.class.php';
/**
 * This class represents a table with learning objects which are candidates for
 * publication.
 */
class FlashVideoContentObjectTable extends ObjectTable
{
    const DEFAULT_NAME = 'flash_video_content_object_table';
    ...
    {
        $data_provider = new FlashVideoContentObjectTableDataProvider($owner, $types, $query, $parent);
        $column_model = new FlashVideoContentObjectTableColumnModel();
        $cell_renderer = new FlashVideoContentObjectTableCellRenderer($table_actions);
        parent :: __construct($data_provider, FlashVideoContentObjectTable :: DEFAULT_NAME, $column_model, $cell_renderer);
