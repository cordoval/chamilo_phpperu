...
use common\extensions\repo_viewer\RepoViewerViewerComponent;

/**
 * $Id: creator.class.php 205 2009-11-13 12:57:33Z vanpouckesven $
 * @package application.common.repo_viewer.component
 */
require_once Path :: get_common_extensions_path() . 'repo_viewer/php/component/viewer.class.php';
/**
 ...
 */
class HtmlEditorFlashVideoRepoViewerViewerComponent extends RepoViewerViewerComponent
{
