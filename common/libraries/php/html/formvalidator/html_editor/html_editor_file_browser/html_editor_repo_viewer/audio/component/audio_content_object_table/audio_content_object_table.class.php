 ...
 */
require_once dirname(__FILE__) . '/audio_content_object_table_data_provider.class.php';
require_once dirname(__FILE__) . '/audio_content_object_table_column_model.class.php';
require_once dirname(__FILE__) . '/audio_content_object_table_cell_renderer.class.php';
/**
 * This class represents a table with learning objects which are candidates for
 * publication.
 */
class AudioContentObjectTable extends ObjectTable
{
    const DEFAULT_NAME = 'audio_content_object_table';
    ...
    function AudioContentObjectTable($parent, $owner, $types, $query, $table_actions)
    {
        ...
        $cell_renderer = new AudioContentObjectTableCellRenderer($table_actions);
        parent :: __construct($data_provider, AudioContentObjectTable :: DEFAULT_NAME, $column_model, $cell_renderer);
