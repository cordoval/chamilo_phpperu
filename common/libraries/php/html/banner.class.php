...
//            $user = $usermgr->get_user();
        ...
        {
            $output[] = '<div style="width: 100%; height: 20px; text-align: center; background-color: lightblue;">' . Translation :: get('LoggedInAsUser', null, UserManager :: APPLICATION_NAME) . ' ' . $user->get_fullname() . ' <a href="index.php?adminuser=1">' . Translation :: get('Back', null, Utilities :: COMMON_LIBRARIES) . '</a></div>';
        }
