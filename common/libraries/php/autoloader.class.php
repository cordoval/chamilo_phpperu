...
class Autoloader
{
    ...
    {
        $list = array(
                'bbcode_parser' => 'bbcode_parser.class.php',
    ...
    {
        $list = array(
                'categorizable' => 'categorizable.class.php',
    ...
    static function check_for_general_files()
    {
        $list = array(
                ...
                'redirect',
                'resource_manager',
                'sub_manager_component',
                'sub_manager',
                'launcher_application',
                'basic_application',
                'messages_object',
                'web_application',
                'web_application_component',
                'user_details');
    ...
    static function check_for_special_files()
    {
        $list = array(
                ...
                'json_ajax_result' => 'string/json_ajax_result.class.php',
    ...
    static function check_for_launcher_files()
    {
        $list = array(
                'attachment_viewer_launcher' => 'launcher/attachment_viewer/attachment_viewer_launcher',
                'complex_builder_launcher' => 'launcher/complex_builder/complex_builder_launcher',
                'complex_display_preview_launcher' => 'launcher/complex_display_preview/complex_display_preview_launcher',
                'external_repository_launcher' => 'launcher/external_repository/external_repository_launcher',
                'html_editor_file_launcher' => 'launcher/html_editor_file/html_editor_file_launcher',
                'repo_viewer_launcher' => 'launcher/repo_viewer/repo_viewer_launcher',
                'video_conferencing_launcher' => 'launcher/video_conferencing/video_conferencing_launcher');
