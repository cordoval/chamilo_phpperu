...
class Utilities
{
    ...
    static function autoload_web($classname)
    {
        ...
        $applications = array('search_portal', 'photo_gallery', 'reservations', 'cas_user', 'personal_calendar','wiki', 'handbook', 'survey', 'cda', 'metadata', 'context_linker', 'forum', 'profiler', 'weblcms');
