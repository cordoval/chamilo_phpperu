...
class Utilities
{
    ...
    static function autoload_web($classname)
    {
        ...
        $applications = array('search_portal', 'linker', 'portfolio', 'photo_gallery', 'reservations', 'cas_user', 'personal_calendar','wiki', 'handbook', 'survey', 'cda', 'metadata', 'context_linker', 'forum', 'profiler', 'weblcms', 'personal_messenger', 'distribute', 'alexia', 'phrases');
