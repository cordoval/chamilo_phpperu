...
class LibrariesAutoloader
{
	...
	static function check_for_general_files($classname)
	{
		$list = array('application_component', 'application', 'block', 'core_application_component', 'core_application',
				      'installer', 'redirect', 'resource_manager', 'sub_manager_component', 'sub_manager', 'launcher_application', 'basic_application', 'messages_object', 'web_application', 'web_application_component', 'user_details');
	...
	static function check_for_special_files($classname)
	{
		$list = array('platform_setting' =>  'configuration/platform_setting.class.php',
					  ...
					  'repo_viewer_launcher' => 'launcher/repo_viewer/repo_viewer_launcher.class.php',
