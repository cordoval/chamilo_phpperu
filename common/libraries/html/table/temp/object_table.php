 ...
 */
require_once Path :: get_library_path().'html/table/gallerytable.class.php';
require_once dirname(__FILE__).'/defaultmichelangelopublicationtablecellrenderer.class.php';

class MichelangeloPublicationTable
{
	/**
	 * Default table name
	 */
	const DEFAULT_NAME = 'michelangelo_publication';
	/**
	...
	function MichelangeloPublicationTable($data_provider, $table_name = null, $cell_renderer = null, $properties = array())
	{
		...
		$this->set_cell_renderer(isset ($cell_renderer) ? $cell_renderer : new DefaultMichelangeloPublicationTableCellRenderer());
	...
	function as_html()
	{
		...
		$table = new GalleryTable($this->get_name(), array ($this, 'get_michelangelo_publication_count'), array ($this, 'get_michelangelo_publications'), array ($this, 'get_properties'), $count);
	 ...
	 */
	function get_michelangelo_publications($offset, $count, $order_property, $order_direction)
	{
		$property = $this->get_properties();
		$objects = $this->get_data_provider()->get_michelangelo_publications($offset, $count, $property[$order_property], $order_direction);
	 ...
	 * of technical limitations.
	 */
	function get_michelangelo_publication_count()
	{
		return $this->get_data_provider()->get_michelangelo_publication_count();
	}
}
?>