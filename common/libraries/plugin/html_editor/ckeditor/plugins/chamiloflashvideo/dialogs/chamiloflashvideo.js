...
(function()
{
	...
	CKEDITOR.dialog.add( 'chamiloflashvideo', function( editor )
	{
		var makeObjectTag = !editor.config.chamiloflashvideoEmbedTagOnly,
			makeEmbedTag = editor.config.chamiloflashvideoAddEmbedTag || editor.config.chamiloflashvideoEmbedTagOnly;

		var previewPreloader,
			previewAreaHtml = '<div>' + CKEDITOR.tools.htmlEncode( editor.lang.common.preview ) +'<br>' +
			'<div id="chamiloflashvideoPreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div>' +
			'<div id="chamiloflashvideoPreviewBox"></div></div>';

		return {
			title : editor.lang.chamiloflashvideo.title,
			minWidth : 420,
			minHeight : 310,
			onShow : function()
			{
				...
				if ( fakeImage && fakeImage.getAttribute( '_cke_real_element_type' ) && fakeImage.getAttribute( '_cke_real_element_type' ) == 'chamiloflashvideo' )
				{
			...
			onOk : function()
			{
				...
				// Apply or remove chamiloflashvideo parameters.
				var extraStyles = {};
				this.commitContent( objectNode, embedNode, paramMap, extraStyles );

				// Refresh the fake image.
				var newFakeImage = editor.createFakeElement( objectNode || embedNode, 'cke_chamiloflashvideo', 'chamiloflashvideo', true );
			...
			contents : [
									...
									[
										{
											...
											required : true,
											validate : CKEDITOR.dialog.validate.notEmpty( editor.lang.chamiloflashvideo.validateSrc ),
											setup : loadValue,
											commit : commitValue,
											onLoad : function()
											{
							...
							[
								{
									...
									id : 'width',
									style : 'width:95px',
									label : editor.lang.chamiloflashvideo.width,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflashvideo.validateWidth ),
								...
								},
								{
									...
									id : 'height',
									style : 'width:95px',
									label : editor.lang.chamiloflashvideo.height,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflashvideo.validateHeight ),
									setup : function( objectNode, embedNode, paramMap, fakeImage )
									{
										loadValue.apply( this, arguments );
										if ( fakeImage )
								...
								},
								{
									...
									id : 'hSpace',
									style : 'width:95px',
									label : editor.lang.chamiloflashvideo.hSpace,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflashvideo.validateHSpace ),
									setup : loadValue,
									commit : commitValue
								},
								{
									...
									id : 'vSpace',
									style : 'width:95px',
									label : editor.lang.chamiloflashvideo.vSpace,
									validate : CKEDITOR.dialog.validate.integer( editor.lang.chamiloflashvideo.validateVSpace ),
									setup : loadValue,
									commit : commitValue
								}
							]
				...
				{
					id : 'properties',
					label : editor.lang.chamiloflashvideo.propertiesTab,
					elements :
					[
						{
							type : 'hbox',
							...
							[
								{
									id : 'scale',
									type : 'select',
									label : editor.lang.chamiloflashvideo.scale,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , ''],
										[ editor.lang.chamiloflashvideo.scaleAll, 'showall' ],
										[ editor.lang.chamiloflashvideo.scaleNoBorder, 'noborder' ],
										[ editor.lang.chamiloflashvideo.scaleFit, 'exactfit' ]
									],
									setup : loadValue,
									commit : commitValue
								},
								{
									...
									type : 'select',
									label : editor.lang.chamiloflashvideo.access,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , ''],
										[ editor.lang.chamiloflashvideo.accessAlways, 'always' ],
										[ editor.lang.chamiloflashvideo.accessSameDomain, 'samedomain' ],
										[ editor.lang.chamiloflashvideo.accessNever, 'never' ]
									],
									setup : loadValue,
									commit : commitValue
								}
							...
							[
								{
									id : 'wmode',
									type : 'select',
									label : editor.lang.chamiloflashvideo.windowMode,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , '' ],
										[ editor.lang.chamiloflashvideo.windowModeWindow, 'window' ],
										[ editor.lang.chamiloflashvideo.windowModeOpaque, 'opaque' ],
										[ editor.lang.chamiloflashvideo.windowModeTransparent, 'transparent' ]
									],
									setup : loadValue,
									commit : commitValue
								},
								{
									id : 'quality',
									type : 'select',
									label : editor.lang.chamiloflashvideo.quality,
									'default' : 'high',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , '' ],
										[ editor.lang.chamiloflashvideo.qualityBest, 'best' ],
										[ editor.lang.chamiloflashvideo.qualityHigh, 'high' ],
										[ editor.lang.chamiloflashvideo.qualityAutoHigh, 'autohigh' ],
										[ editor.lang.chamiloflashvideo.qualityMedium, 'medium' ],
										[ editor.lang.chamiloflashvideo.qualityAutoLow, 'autolow' ],
										[ editor.lang.chamiloflashvideo.qualityLow, 'low' ]
									],
									setup : loadValue,
									commit : commitValue
								}
							...
							[
								{
									id : 'align',
									type : 'select',
									label : editor.lang.chamiloflashvideo.align,
									'default' : '',
									style : 'width : 100%;',
									items :
									[
										[ editor.lang.common.notSet , ''],
										[ editor.lang.chamiloflashvideo.alignLeft , 'left'],
										[ editor.lang.chamiloflashvideo.alignAbsBottom , 'absBottom'],
										[ editor.lang.chamiloflashvideo.alignAbsMiddle , 'absMiddle'],
										[ editor.lang.chamiloflashvideo.alignBaseline , 'baseline'],
										[ editor.lang.chamiloflashvideo.alignBottom , 'bottom'],
										[ editor.lang.chamiloflashvideo.alignMiddle , 'middle'],
										[ editor.lang.chamiloflashvideo.alignRight , 'right'],
										[ editor.lang.chamiloflashvideo.alignTextTop , 'textTop'],
										[ editor.lang.chamiloflashvideo.alignTop , 'top']
									],
									setup : loadValue,
									commit : commitValue
								},
						...
						},
						{
							...
							[
								{
									type : 'html',
									html : CKEDITOR.tools.htmlEncode( editor.lang.chamiloflashvideo.flashvars )
								},
								{
									type : 'checkbox',
									id : 'menu',
									label : editor.lang.chamiloflashvideo.chkMenu,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								},
								{
									type : 'checkbox',
									id : 'play',
									label : editor.lang.chamiloflashvideo.chkPlay,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								},
								{
									type : 'checkbox',
									id : 'loop',
									label : editor.lang.chamiloflashvideo.chkLoop,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								},
								{
									type : 'checkbox',
									id : 'allowFullScreen',
									label : editor.lang.chamiloflashvideo.chkFull,
									'default' : true,
									setup : loadValue,
									commit : commitValue
								}
							...
							[
								{
									type : 'text',
									id : 'bgcolor',
									label : editor.lang.chamiloflashvideo.bgcolor,
									setup : loadValue,
									commit : commitValue
								},
								{
