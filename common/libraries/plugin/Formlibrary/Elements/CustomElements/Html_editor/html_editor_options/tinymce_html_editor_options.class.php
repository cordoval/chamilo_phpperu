...
class FormLibraryTinymceHtmlEditorOptions extends FormLibraryHtmlEditorOptions
{
...
//	    $mapping[self :: OPTION_FULL_PAGE] = 'fullPage';
	...
	function get_toolbar_format($toolbar_name)
	{
	...
	function set_defaults()
	{
	    ...
	    //$this->set_option(self :: OPTION_TEMPLATES, Path :: get(REL_PATH) . 'plugin/FormLibrary/Elements/CustomElements/Hmtl_editor/form_library_html_editor_templates_instance.php');/*'common/html/formvalidator/form_validator_html_editor_templates_instance.php');*/
