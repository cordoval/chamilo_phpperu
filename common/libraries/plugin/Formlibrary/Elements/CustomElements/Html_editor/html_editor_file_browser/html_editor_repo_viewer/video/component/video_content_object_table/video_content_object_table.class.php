 ...
 */
require_once dirname(__FILE__) . '/video_content_object_table_data_provider.class.php';
require_once dirname(__FILE__) . '/video_content_object_table_column_model.class.php';
require_once dirname(__FILE__) . '/video_content_object_table_cell_renderer.class.php';
/**
 * This class represents a table with learning objects which are candidates for
 * publication.
 */
class VideoContentObjectTable extends ObjectTable
{
     ...
     */
    function VideoContentObjectTable($parent, $owner, $types, $query, $table_actions)
    {
        $data_provider = new VideoContentObjectTableDataProvider($owner, $types, $query, $parent);
        $column_model = new VideoContentObjectTableColumnModel();
        $cell_renderer = new VideoContentObjectTableCellRenderer($table_actions);
        parent :: __construct($data_provider, VideoContentObjectTable :: DEFAULT_NAME, $column_model, $cell_renderer);
