...
* @version  CVS: $Id: Text.php 283202 2009-06-30 20:26:09Z cweiske $
...
require_once dirname(__FILE__) . '/../Element/Span.php';
require_once dirname(__FILE__) . '/../Element/Paragraph.php';
require_once dirname(__FILE__) . '/../Element/Heading.php';
require_once dirname(__FILE__) . '/../Element/Bookmark.php';
require_once dirname(__FILE__) . '/../Element/Hyperlink.php';
