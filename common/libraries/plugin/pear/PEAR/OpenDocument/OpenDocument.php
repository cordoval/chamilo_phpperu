...
* @version  CVS: $Id: OpenDocument.php 283194 2009-06-30 18:35:53Z cweiske $
* @link     http://pear.php.net/package/OpenDocument
* @since    File available since Release 0.1.0
*/

require_once dirname(__FILE__) . '/OpenDocument/Storage/Zip.php';
require_once dirname(__FILE__) . '/OpenDocument/Exception.php';
