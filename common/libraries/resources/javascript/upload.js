...
function upload(latency){ 
	...
	var __progress_bar_img = web_path + '/common/resources/images/' + getTheme() + '/action_progress_bar.gif';
	var __progress_bar_text = getTranslation('Uploading', 'common\\libraries');
