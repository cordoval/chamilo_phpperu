...
$(function()
{
    ...
    var replacement = attributeReplacement
            + " <a class=\"cda_link\" href=\"http://translate.chamilo.org/translate.php?context=$1&variable=$2\"><img src=\"common/libraries/resources/images/aqua/action_translate.png\" style=\"width: 7px; height: 7px;\" /></a>";
    ...
    function showColorTip(e, ui)
    {
        ...
        var tip = $('<span class="colorTip">' + eventsContent + '<span class="pointyTipShadow"></span><span class="pointyTip"></span></span>');
            ...
            .ready(function()
            {
                ...
                // $("body *").replaceText('[=', "" );
                    ...
                    $("body *")
                            .replaceText(
                                    cdaMatchRegExp,
                                    "$2 <a class=\"cda_link\" href=\"http://translate.chamilo.org/translate.php?context=$1&variable=$2\"><img src=\"http://localhost/chamilocode/common/libraries/resources/images/aqua/action_translate.png\" style=\"width: 7px; height: 7px;\" /></a>",
                                    "$2");
