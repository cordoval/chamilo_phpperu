...
$(function () {
	...
	{
		$("#internship_organizer_tabs ul").css('display', 'block');
		$("#internship_organizer_tabs h2").hide();
		$("#internship_organizer_tabs").tabs();
		var tabs = $('#internship_organizer_tabs').tabs('paging', { cycle: false, follow: false, nextButton : "", prevButton : "" } );
