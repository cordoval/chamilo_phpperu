...
class ExternalRepositoryBrowserTable extends ObjectTable
{
    static function factory($type, $browser, $parameters, $condition)
    {
        ...
        require_once Path :: get_common_extensions_path() . 'external_repository_manager/type/' . $type . '/component/' . $type . '_external_repository_table/' . $type . '_external_repository_table.class.php';
