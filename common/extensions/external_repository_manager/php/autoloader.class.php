...
class Autoloader
{
    ...
    static function load($classname)
    {
        $list = array(
            ...
            'streaming_media_external_repository_browser_gallery_table_cell_renderer' => 'general/streaming/streaming_media_external_repository_browser_gallery_table_cell_renderer.class.php',
        );
