...
class ExternalRepositoryBrowserGalleryTable
{
    ...
    static function factory($type, $browser, $parameters, $condition)
    {
        ...
        require_once Path :: get_common_extensions_path() . 'external_repository_manager/type/' . $type . '/component/' . $type . '_external_repository_gallery_table/' . $type . '_external_repository_gallery_table.class.php';
