...
class DropboxExternalRepositoryManagerImporterComponent extends DropboxExternalRepositoryManager
{
    ...
    function import_external_repository_object($external_object)
    {
    	if ($external_object->is_importable())
        {
            ...
            if ($file->create())
            {
                ExternalSync :: quicksave($file, $external_object, $this->get_external_repository()->get_id());
