...
require_once dirname(__FILE__) . '/slideshare_rest_result.class.php';

class SlideshareRestClient extends RestClient
{
    ...
    function __construct($slideshare_url)
    {
        parent :: __construct();
    ...
    protected function send_pear_request()
    {
        ...
        $result = new SlideshareRestResult();
