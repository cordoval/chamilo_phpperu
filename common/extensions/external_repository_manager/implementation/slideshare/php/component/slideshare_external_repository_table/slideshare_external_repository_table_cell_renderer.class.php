 ...
 */
class SlideshareExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === SlideshareExternalRepositoryTableColumnModel :: get_modification_column())
        {
