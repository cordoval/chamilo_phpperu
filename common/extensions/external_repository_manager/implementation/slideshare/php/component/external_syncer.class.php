...
class SlideshareExternalRepositoryManagerExternalSyncerComponent extends SlideshareExternalRepositoryManager
{
    ...
    function synchronize_external_repository_object(ExternalRepositoryObject $external_object)
    {
        ...
        else
        {
            ...
            $parameters[ExternalRepositoryManager :: PARAM_EXTERNAL_REPOSITORY_ID] = $external_object->get_id();
            $this->redirect(Translation :: get('ObjectFailedUpdated', array(
                    'OBJECT' => Translation :: get('ExternalRepository')), Utilities :: COMMON_LIBRARIES), true, $parameters);
        }
    }
}
?>