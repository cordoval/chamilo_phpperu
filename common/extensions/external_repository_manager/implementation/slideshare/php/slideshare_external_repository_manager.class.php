...
class SlideshareExternalRepositoryManager extends ExternalRepositoryManager
{
    ...
    {
        return Path :: get_common_extensions_path() . 'external_repository_manager/implementation/slideshare/php/component/';
    }
