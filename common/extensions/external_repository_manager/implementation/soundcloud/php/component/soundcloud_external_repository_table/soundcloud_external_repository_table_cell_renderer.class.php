 ...
 */
class SoundcloudExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
     ...
     */
    function SoundcloudExternalRepositoryTableCellRenderer($browser)
    {
        parent :: __construct();
    ...
    {
        if ($column === SoundcloudExternalRepositoryTableColumnModel :: get_modification_column())
        {
        ...
        switch ($column->get_name())
        {
            ...
            case SoundcloudExternalRepositoryObject :: PROPERTY_LICENSE :
