 ...
 */
class SoundcloudExternalRepositoryTableColumnModel extends DefaultExternalRepositoryObjectTableColumnModel
{
    /**
     ...
     * Constructor
     */
    function SoundcloudExternalRepositoryTableColumnModel()
    {
        parent :: __construct();
        $this->set_default_order_column(1);
        $this->add_column(new ObjectTableColumn(SoundcloudExternalRepositoryObject :: PROPERTY_LICENSE));
