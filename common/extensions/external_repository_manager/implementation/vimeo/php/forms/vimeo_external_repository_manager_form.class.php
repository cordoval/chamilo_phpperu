...
/**
 * $Id: vimeo_external_repository_manager_form.class.php 224 2009-11-13 14:40:30Z kariboe $
 * @package
 */

class VimeoExternalRepositoryManagerForm extends FormValidator
{
    ...
    function VimeoExternalRepositoryManagerForm($form_type, $action, $application)
    {
