 ...
 */
class VimeoExternalRepositoryTableColumnModel extends DefaultExternalRepositoryObjectTableColumnModel
{
    /**
    ...
    function VimeoExternalRepositoryTableColumnModel()
    {
        ...
        $this->add_column(new ObjectTableColumn(VimeoExternalRepositoryObject :: PROPERTY_LICENSE));
