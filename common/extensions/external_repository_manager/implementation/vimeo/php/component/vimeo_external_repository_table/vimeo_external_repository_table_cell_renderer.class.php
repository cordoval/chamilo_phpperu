 ...
 */
class VimeoExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
     ...
     */
    function VimeoExternalRepositoryTableCellRenderer($browser)
    {
        parent :: __construct();
    ...
    {
        if ($column === VimeoExternalRepositoryTableColumnModel :: get_modification_column())
        {
        ...
        switch ($column->get_name())
        {
            ...
            case VimeoExternalRepositoryObject :: PROPERTY_LICENSE :
