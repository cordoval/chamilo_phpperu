...
class BoxNetExternalRepositoryManager extends ExternalRepositoryManager
{
    const REPOSITORY_TYPE = 'box_net';
    ...
    {
        return Path :: get_common_extensions_path() . 'external_repository_manager/implementation/box_net/php/component/';
    }
...
//        }
    ...
    function get_menu_items()
    {
        ...
        $general = array();
        $general['title'] = Translation :: get('Box_net');
