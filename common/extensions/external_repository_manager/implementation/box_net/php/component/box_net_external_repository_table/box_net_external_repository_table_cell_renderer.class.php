 ...
 */
class BoxNetExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === BoxNetExternalRepositoryTableColumnModel :: get_modification_column())
        {
        ...
        switch ($column->get_name())
        {
            ...
            case BoxNetExternalRepositoryObject :: PROPERTY_DESCRIPTION :
                return $external_object->get_description(); 
           	case BoxNetExternalRepositoryObject :: PROPERTY_CREATED :
