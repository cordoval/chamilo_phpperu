 ...
 */
class BoxNetExternalRepositoryTableColumnModel extends DefaultExternalRepositoryObjectTableColumnModel
{
    /**
    ...
    function __construct()
    {
        ...
        //$this->add_column(new ObjectTableColumn(BoxNetExternalRepositoryObject :: PROPERTY_LICENSE));
