 ...
 */
class WikipediaExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === WikipediaExternalRepositoryTableColumnModel :: get_modification_column())
        {
