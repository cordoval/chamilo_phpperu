...
require_once dirname(__FILE__) . '/wikipedia_rest_result.class.php';

class WikipediaRestClient extends RestClient
{
    ...
    function __construct($wikipedia_url)
    {
        parent :: __construct();
    ...
    protected function send_pear_request()
    {
        ...
        $result = new WikipediaRestResult();
