    ...
    function synchronize_internal_repository_object(ExternalRepositoryObject $external_object)
    {
        ...
        if ($content_object->update())
        {
            ...
            if ($synchronization_data->update())
            {
                ...
                $this->redirect(Translation :: get('ObjectUpdated', array('ContentObject' => Translation :: get('ContentObject')), Utilities :: COMMON_LIBRARIES), false, $parameters, array(
            ...
            else
            {
                ...
                $this->redirect(Translation :: get('ObjectUpdated', array('ContentObject' => Translation :: get('ContentObject')), Utilities :: COMMON_LIBRARIES), true, $parameters);
            }
        }
        else
        {
