...
class Hq23ExternalRepositoryGalleryTableCellRenderer extends DefaultExternalRepositoryGalleryObjectTableCellRenderer
{
    /**
     ...
     */
    function Hq23ExternalRepositoryGalleryTableCellRenderer($browser)
    {
        parent :: __construct();
