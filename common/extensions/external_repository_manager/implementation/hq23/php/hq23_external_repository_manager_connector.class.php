...
class Hq23ExternalRepositoryManagerConnector extends ExternalRepositoryManagerConnector
{
    ...
    static function get_instance($instance_id)
    {
        ...
        {
            self :: $instance[$instance_id] = new Hq23ExternalRepositoryManagerConnector($instance_id);
        }
