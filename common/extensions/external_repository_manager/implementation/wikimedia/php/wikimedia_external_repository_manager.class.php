...
require_once dirname(__FILE__) . '/wikimedia_external_repository_manager_connector.class.php';

/**
 * @author Hans De Bisschop
 */
class WikimediaExternalRepositoryManager extends ExternalRepositoryManager
{
    ...
    {
        return Path :: get_common_extensions_path() . 'external_repository_manager/implementation/wikimedia/php/component/';
    }
