 ...
 */
class WikimediaExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === WikimediaExternalRepositoryTableColumnModel :: get_modification_column())
        {
        ...
        switch ($column->get_name())
        {
            ...
            case WikimediaExternalRepositoryObject :: PROPERTY_LICENSE :
