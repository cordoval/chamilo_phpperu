...
require_once dirname(__FILE__) . '/wikimedia_rest_result.class.php';

class WikimediaRestClient extends RestClient
{
    ...
    function __construct($wikimedia_url)
    {
        parent :: __construct();
    ...
    protected function send_pear_request()
    {
        ...
        $result = new WikimediaRestResult();
