...
// Setup variables
    ...
    var $_box_api_download_url = 'https://www.box.net/api/1.0/download';
    ...
    function makeRequest($method, $params = array()) 
    {
    	...
    	else if ($method == 'download')
        {
	    	...
	    	if ($this->_debug){ echo "Download Request: ".$request; }        
    	}    	
    	else
    	{            
        	$args = array();
    ...
    function get_file_info($file_id, $params = array())
    {
    	$params['api_key']  = $this->api_key;
    	$params['auth_token']   = $this->auth_token;
	    ...
	    foreach($data as $d)
	    {
	    	switch ($d['tag']) 
	        {
	           case 'FILE_ID':	$ret_array['file_id'] = $d['value'];
	            					break;
	           case 'FILE_NAME': $ret_array['file_name'] = $d['value'];
	            					break;
	           case 'FOLDER_ID': $ret_array['folder_id'] = $d['value'];
	            					break;	            	
	           case 'CREATED': 	$ret_array['created'] = $d['value'];
	            				break;
	           case 'UPDATED':	$ret_array['updated'] = $d['value'];
	            				break;	            		 
	        }
	    }    
	    return $ret_array;
		...
		function get_files($folder_id, $params = array()) 
        {    
	        $params['api_key']  = $this->api_key;
	        $params['auth_token']   = $this->auth_token;
	        $params['folder_id']    = 0;
		...
		function delete_file($file_id, $params = array()) 
        {    
	        $params['api_key']  = $this->api_key;
	        $params['auth_token']   = $this->auth_token;
	        $params['target'] = 'file';
		...
		function download_file($file_id, $params = array()) 
        {    
	        $params['auth_token']   = $this->auth_token;
	        $params['file_id'] = $file_id;
	...
	function rename_file($file_id, $new_name, $params = array()) 
	{
		$params['api_key']  = $this->api_key;
		$params['auth_token'] 	=  $this->auth_token;
		$params['target']  = 'file';
