...
class PicasaExternalRepositoryManagerUploaderComponent extends PicasaExternalRepositoryManager
{

    function run()
    {
        $form = new PicasaExternalRepositoryManagerForm(PicasaExternalRepositoryManagerForm :: TYPE_CREATE, $this->get_url(), $this);
