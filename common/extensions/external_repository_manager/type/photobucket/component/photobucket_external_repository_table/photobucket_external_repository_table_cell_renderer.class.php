 ...
 */
class PhotobucketExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
     ...
     */
    function PhotobucketExternalRepositoryTableCellRenderer($browser)
    {
        parent :: __construct();
    ...
    {
        if ($column === PhotobucketExternalRepositoryTableColumnModel :: get_modification_column())
        {
