<?php
class MatterhornExternalRepositoryObjectTrackAudio
{
	private $id;
	private $device;
	private $encoder;
	...
	private function get_channels_as_string()
	{
		...
		{
			case 1 : return Translation :: get('Mono'); break;
			case 2 : return Translation :: get('Stereo'); break;
			
			default : return ($this->get_channels() . ' ' . Translation :: get('Surround'));
		}
	} 
