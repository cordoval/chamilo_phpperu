 ...
 */
class Hq23ExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === Hq23ExternalRepositoryTableColumnModel :: get_modification_column())
        {
        ...
        switch ($column->get_name())
        {
            ...
            case Hq23ExternalRepositoryObject :: PROPERTY_LICENSE :
