 ...
 */
class YoutubeExternalRepositoryTableCellRenderer extends DefaultExternalRepositoryObjectTableCellRenderer
{
    /**
    ...
    {
        if ($column === YoutubeExternalRepositoryTableColumnModel :: get_modification_column())
        {
