...
class DynamicFormElement extends DataClass
{
    ...
    {
        return parent :: get_default_property_names(array(self :: PROPERTY_DYNAMIC_FORM_ID, self :: PROPERTY_NAME, self :: PROPERTY_TYPE, self :: PROPERTY_REQUIRED, self :: PROPERTY_DISPLAY_ORDER));
    }
    ...
    {
        return array(
                Translation :: get('Textbox') => self :: TYPE_TEXTBOX, Translation :: get('HtmlEditor') => self :: TYPE_HTMLEDITOR, Translation :: get('Checkbox') => self :: TYPE_CHECKBOX, Translation :: get('RadioButtons') => self :: TYPE_RADIO_BUTTONS,
