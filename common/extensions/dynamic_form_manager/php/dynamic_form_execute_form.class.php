...
class DynamicFormExecuteForm extends FormValidator
{
    ...
    function setDefaults($parameters = array())
    {
        ...
        {
            $element = AdminDataManager :: get_instance()->retrieve_dynamic_form_elements(new EqualityCondition(DynamicFormElement :: PROPERTY_ID, $value->get_dynamic_form_element_id()))->next_result();
