...
class ExtensionsAutoloader
{
    ...
    static function load($classname)
    {
        ...
        if (self :: check_for_external_repository_files())
        {
            return true;
        }
    ...
    static function check_for_external_repository_files()
    {
        $list = array(
    ...
    {
        $list = array(
                'category_manager' => 'category_manager/php/category_manager.class.php', 'feedback_manager' => 'feedback_manager/php/feedback_manager.class.php',
                'invitation_manager' => 'invitation_manager/php/invitation_manager.class.php', 'invitation' => 'invitation_manager/php/invitation.class.php', 'invitation_form' => 'invitation_manager/php/invitation_form.class.php',
                'invitation_support' => 'invitation_manager/php/invitation_support.class.php', 'invitation_parameters' => 'invitation_manager/php/invitation_parameters.class.php', 'repo_viewer' => 'repo_viewer/php/repo_viewer.class.php',
                'repo_viewer_interface' => 'repo_viewer/php/repo_viewer_interface.class.php', 'reporting_viewer' => 'reporting_viewer/php/reporting_viewer.class.php',
