        ...
        AdministrationComponent
{
    ...
    private function get_row_modification_links($home_row, $index)
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('Edit', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_edit.png', $this->get_home_row_editing_url($home_row), ToolbarItem :: DISPLAY_ICON));

        $toolbar->add_item(new ToolbarItem(Translation :: get('Delete', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_delete.png', $this->get_home_row_deleting_url($home_row), ToolbarItem :: DISPLAY_ICON, true));
        ...
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveUp', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_up.png', $this->get_home_row_moving_url($home_row, 'up'), ToolbarItem :: DISPLAY_ICON));
        }
        ...
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveDown', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_down.png', $this->get_home_row_moving_url($home_row, 'down'), ToolbarItem :: DISPLAY_ICON));
        }
    ...
    private function get_column_modification_links($home_column, $index)
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('Edit', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_edit.png', $this->get_home_column_editing_url($home_column), ToolbarItem :: DISPLAY_ICON));

        $toolbar->add_item(new ToolbarItem(Translation :: get('Delete', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_delete.png', $this->get_home_column_deleting_url($home_column), ToolbarItem :: DISPLAY_ICON, true));

        if ($index == 'first' || $index == 'single')
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveLeftNA', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_left_na.png', null, ToolbarItem :: DISPLAY_ICON));
        }
        else
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveLeft', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_left.png', $this->get_home_column_moving_url($home_column, 'up'), ToolbarItem :: DISPLAY_ICON));
        }

        if ($index == 'last' || $index == 'single')
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveRightNA', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_right_na.png', null, ToolbarItem :: DISPLAY_ICON));
        }
        else
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveRight', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_right.png', $this->get_home_column_moving_url($home_column, 'down'), ToolbarItem :: DISPLAY_ICON));
        }
    ...
    private function get_block_modification_links($home_block, $index)
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('Edit', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_edit.png', $this->get_home_block_editing_url($home_block), ToolbarItem :: DISPLAY_ICON));

        $toolbar->add_item(new ToolbarItem(Translation :: get('Configure'), Theme :: get_common_image_path() . 'action_config.png', $this->get_home_block_configuring_url($home_block), ToolbarItem :: DISPLAY_ICON));

        $toolbar->add_item(new ToolbarItem(Translation :: get('Delete', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_delete.png', $this->get_home_block_deleting_url($home_block), ToolbarItem :: DISPLAY_ICON, true));
        ...
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveUp', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_up.png', $this->get_home_block_moving_url($home_block, 'up'), ToolbarItem :: DISPLAY_ICON));
        }
        ...
        {
            $toolbar->add_item(new ToolbarItem(Translation :: get('MoveDown', null, Utilities :: COMMON_LIBRARIES), Theme :: get_common_image_path() . 'action_down.png', $this->get_home_block_moving_url($home_block, 'down'), ToolbarItem :: DISPLAY_ICON));
        }
    ...
    function get_manager_modification_links()
    {
        ...
        $toolbar->add_item(new ToolbarItem(Translation :: get('AddRow'), Theme :: get_common_image_path() . 'action_add.png', $this->get_home_row_creation_url(), ToolbarItem :: DISPLAY_ICON_AND_LABEL));

        $toolbar->add_item(new ToolbarItem(Translation :: get('AddColumn'), Theme :: get_common_image_path() . 'action_add.png', $this->get_home_column_creation_url(), ToolbarItem :: DISPLAY_ICON_AND_LABEL));

        $toolbar->add_item(new ToolbarItem(Translation :: get('AddBlock'), Theme :: get_common_image_path() . 'action_add.png', $this->get_home_block_creation_url(), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
